"use strict";
var Js = Object.defineProperty, Yr = (t8, e) => {
  for (var r in e)
    Js(t8, r, { get: e[r], enumerable: !0 });
}, jr = (t8, e, r) => {
  if (!e.has(t8))
    throw TypeError("Cannot " + r);
}, Q = (t8, e, r) => (jr(t8, e, "read from private field"), r ? r.call(t8) : e.get(t8)), Kr = (t8, e, r) => {
  if (e.has(t8))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t8) : e.set(t8, r);
}, Qr = (t8, e, r, n) => (jr(t8, e, "write to private field"), n ? n.call(t8, r) : e.set(t8, r), r), Ur = {};
Yr(Ur, { languages: () => Cs, options: () => _s, parsers: () => Vr, printers: () => Lo });
var Zs = (t8, e, r, n) => {
  if (!(t8 && e == null))
    return e.replaceAll ? e.replaceAll(r, n) : r.global ? e.replace(r, n) : e.split(r).join(n);
}, w = Zs, xe = "string", ke = "array", Be = "cursor", ue = "indent", le = "align", Le = "trim", te = "group", ce = "fill", pe = "if-break", he = "indent-if-break", Fe = "line-suffix", Pe = "line-suffix-boundary", Y = "line", Ne = "label", fe = "break-parent", mt = /* @__PURE__ */ new Set([Be, ue, le, Le, te, ce, pe, he, Fe, Pe, Y, Ne, fe]);
function ei(t8) {
  if (typeof t8 == "string")
    return xe;
  if (Array.isArray(t8))
...
var Ie = ei, ti = (t8) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t8);
function ri(t8) {
...
function L(t8) {
  return { type: ue, contents: t8 };
}
function Jr(t8, e) {
  return { type: le, contents: e, n: t8 };
}
function E(t8, e = {}) {
  return { type: te, id: e.id, contents: t8, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function Zr(t8) {
...
function Ct(t8) {
  return { type: ce, parts: t8 };
}
function me(t8, e = "", r = {}) {
  return { type: pe, breakContents: t8, flatContents: e, groupId: r.groupId };
}
function tn(t8, e) {
  return { type: he, contents: t8, groupId: e.groupId, negate: e.negate };
}
var ne = { type: fe }, ni = { type: Y, hard: !0 }, si = { type: Y, hard: !0, literal: !0 }, A = { type: Y }, v = { type: Y, soft: !0 }, S = [ni, ne], rn = [si, ne];
function M(t8, e) {
  let r = [];
  ...
  switch (Ie(t8)) {
    ...
    case te:
      if (!t8.contents && !t8.id && !t8.break && !t8.expandedStates)
        return "";
      if (t8.contents.type === te && t8.contents.id === t8.id && t8.contents.break === t8.break && t8.contents.expandedStates === t8.expandedStates)
        return t8.contents;
      break;
    case le:
    case ue:
...
var _t = "'", sn = '"';
function oi(t8, e) {
  let r = e === !0 || e === _t ? _t : sn, n = r === _t ? sn : _t, s = 0, i = 0;
  for (let a of t8)
    a === r ? s++ : a === n && i++;
  return s > i ? n : r;
}
...
var q, sr = class {
  constructor(e) {
    Kr(this, q, void 0), Qr(this, q, new Set(e));
  }
...
var on = sr, ui = ["	", `
`, "\f", "\r", " "], li = new on(ui), F = li, ir = class extends Error {
...
var Re = ci, pi = /* @__PURE__ */ new Set(["sourceSpan", "startSourceSpan", "endSourceSpan", "nameSpan", "valueSpan", "keySpan", "tagDefinition", "tokens", "valueTokens", "switchValueSourceSpan", "expSourceSpan", "valueSourceSpan"]), hi = /* @__PURE__ */ new Set(["if", "else if", "for", "switch", "case"]);
function ln(t8, e) {
  var r;
  if (t8.type === "text" || t8.type === "comment" || Re(t8) || t8.type === "yaml" || t8.type === "toml")
    return null;
...
function mi(t8, e, r, n) {
  ...
  return /^\s*$/.test(i) ? "" : x(i, t8, { parser: "__ng_directive", __isInHtmlAttribute: !1, trailingComma: "none" }, j);
}
var hn = mi, gi = (t8) => String(t8).split(/[/\\]/).pop();
function fn(t8, e) {
  if (!e)
    return;
  let r = gi(e).toLowerCase();
  return t8.find(({ filenames: n }) => n?.some((s) => s.toLowerCase() === r)) ?? t8.find(({ extensions: n }) => n?.some((s) => r.endsWith(s)));
}
function di(t8, e) {
  if (e)
    return t8.find(({ name: r }) => r.toLowerCase() === e) ?? t8.find(({ aliases: r }) => r?.includes(e)) ?? t8.find(({ extensions: r }) => r?.includes(`.${e}`));
}
function Ci(t8, e) {
  let r = t8.plugins.flatMap((s) => s.languages ?? []), n = di(r, e.language) ?? fn(r, e.physicalFile) ?? fn(r, e.file) ?? void 0;
  return n?.parsers[0];
}
var $e = Ci, mn = "inline", gn = { area: "none", base: "none", basefont: "none", datalist: "none", head: "none", link: "none", meta: "none", noembed: "none", noframes: "none", param: "block", rp: "none", script: "block", style: "none", template: "inline", title: "none", html: "block", body: "block", address: "block", blockquote: "block", center: "block", dialog: "block", div: "block", figure: "block", figcaption: "block", footer: "block", form: "block", header: "block", hr: "block", legend: "block", listing: "block", main: "block", p: "block", plaintext: "block", pre: "block", search: "block", xmp: "block", slot: "contents", ruby: "ruby", rt: "ruby-text", article: "block", aside: "block", h1: "block", h2: "block", h3: "block", h4: "block", h5: "block", h6: "block", hgroup: "block", nav: "block", section: "block", dir: "block", dd: "block", dl: "block", dt: "block", menu: "block", ol: "block", ul: "block", li: "list-item", table: "table", caption: "table-caption", colgroup: "table-column-group", col: "table-column", thead: "table-header-group", tbody: "table-row-group", tfoot: "table-footer-group", tr: "table-row", td: "table-cell", th: "table-cell", input: "inline-block", button: "inline-block", fieldset: "block", marquee: "inline-block", source: "block", track: "block", details: "block", summary: "block", meter: "inline-block", progress: "inline-block", object: "inline-block", video: "inline-block", audio: "inline-block", select: "inline-block", option: "block", optgroup: "block" }, dn = "normal", Cn = { listing: "pre", plaintext: "pre", pre: "pre", xmp: "pre", nobr: "nowrap", table: "initial", textarea: "pre-wrap" };
function Si(t8) {
  return t8.type === "element" && !t8.hasExplicitNamespace && !["html", "svg"].includes(t8.namespace);
}
var de = Si, _i = (t8) => w(!1, t8, /^[\t\f\r ]*\n/g, ""), ar = (t8) => _i(F.trimEnd(t8)), Sn = (t8) => {
...
function Se(t8) {
  return t8.type === "attribute" || !t8.parent || !t8.prev ? !1 : Ei(t8.prev);
}
function Ei(t8) {
...
function An(t8, e) {
  ...
  return r;
  function n() {
    return Re(t8) || t8.type === "angularControlFlowBlock" ? !1 : (t8.type === "text" || t8.type === "interpolation") && t8.prev && (t8.prev.type === "text" || t8.prev.type === "interpolation") ? !0 : !t8.parent || t8.parent.cssDisplay === "none" ? !1 : Ce(t8.parent) ? !0 : !(!t8.prev && (t8.parent.type === "root" || Ce(t8) && t8.parent || U(t8.parent) || Je(t8.parent, e) || !bi(t8.parent.cssDisplay)) || t8.prev && !ki(t8.prev.cssDisplay));
  }
}
function Dn(t8, e) {
  return Re(t8) || t8.type === "angularControlFlowBlock" ? !1 : (t8.type === "text" || t8.type === "interpolation") && t8.next && (t8.next.type === "text" || t8.next.type === "interpolation") ? !0 : !t8.parent || t8.parent.cssDisplay === "none" ? !1 : Ce(t8.parent) ? !0 : !(!t8.next && (t8.parent.type === "root" || Ce(t8) && t8.parent || U(t8.parent) || Je(t8.parent, e) || !Ti(t8.parent.cssDisplay)) || t8.next && !xi(t8.next.cssDisplay));
}
function vn(t8) {
...
async function Nn(t8, e) {
  let r = [];
  for (let [n, s] of t8.split(hr).entries())
    if (n % 2 === 0)
      r.push(T(s));
    else
      try {
        r.push(E(["{{", L([A, await x(s, e, { parser: "__ng_interpolation", __isInHtmlInterpolation: !0, trailingComma: "none" })]), A, "}}"]));
      } catch {
        r.push("{{", T(s), "}}");
      }
  return r;
}
function fr({ parser: t8 }) {
  return (e, r, n) => x(P(n.node), e, { parser: t8, trailingComma: "none" }, j);
}
var Ni = fr({ parser: "__ng_action" }), Ii = fr({ parser: "__ng_binding" }), Ri = fr({ parser: "__ng_directive" });
function $i(t8, e) {
  if (e.parser !== "angular")
    return;
...
var Mi = /^[ \t\n\r\u000c]+/, qi = /^[, \t\n\r\u000c]+/, Hi = /^[^ \t\n\r\u000c]+/, Vi = /[,]+$/, On = /^\d+$/, Ui = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/;
function Wi(t8) {
  ...
  function g() {
    let C = !1, _, D, I, B, c = {}, d, y, O, b, V;
    for (B = 0; B < n.length; B++)
      d = n[B], y = d[d.length - 1], O = d.substring(0, d.length - 1), b = parseInt(O, 10), V = parseFloat(O), On.test(O) && y === "w" ? ((_ || D) && (C = !0), b === 0 ? C = !0 : _ = b) : Ui.test(O) && y === "x" ? ((_ || D || I) && (C = !0), V < 0 ? C = !0 : D = V) : On.test(O) && y === "h" ? ((I || D) && (C = !0), b === 0 ? C = !0 : I = b) : C = !0;
    if (!C)
      c.source = { value: r, startOffset: u }, _ && (c.width = { value: _ }), D && (c.density = { value: D }), I && (c.height = { value: I }), l.push(c);
    else
...
var qn = { width: "w", height: "h", density: "x" }, Gi = Object.keys(qn);
function Yi(t8) {
...
function Vn(t8, e) {
  ...
  if (r.fullName === "style" && !e.parentParser && !n.includes("{{"))
    return async (s) => ge(await s(n, { parser: "css", __isHTMLStyleAttribute: !0 }));
}
...
function Un(t8, e, r) {
  let { node: n } = r, s = P(n);
  return x(`type T<${s}> = any`, t8, { parser: "babel-ts", __isEmbeddedTypescriptGenericParameters: !0 }, j);
}
function Wn(t8, e, { parseWithTs: r }) {
...
async function Gn(t8, e, r, n) {
  let s = P(r.node), { left: i, operator: a, right: o } = Ki(s), u = Oe(r, n);
  return [E(await x(`function _(${i}) {}`, t8, { parser: u ? "babel-ts" : "babel", __isVueForBindingLeft: !0 })), " ", a, " ", await x(o, t8, { parser: u ? "__ts_expression" : "__js_expression" })];
}
function Ki(t8) {
...
function Qi(t8, e) {
  ...
  if (n === "v-for")
    return Gn;
  if (n === "generic" && wt(r.parent, e))
    return Un;
  let s = P(r), i = Oe(t8, e);
  if (Fn(r) || Pn(r, e))
    return (a) => Wn(s, a, { parseWithTs: i });
  ...
  if (n.startsWith("v-"))
    return (a) => Yn(s, a, { parseWithTs: i });
}
function Xi(t8, e, { parseWithTs: r }) {
  return zn(t8) ? Yn(t8, e, { parseWithTs: r }) : x(t8, e, { parser: r ? "__vue_ts_event_binding" : "__vue_event_binding" }, j);
}
function Ji(t8, e, { parseWithTs: r }) {
  return x(t8, e, { parser: r ? "__vue_ts_expression" : "__vue_expression" }, j);
}
function Yn(t8, e, { parseWithTs: r }) {
  return x(t8, e, { parser: r ? "__ts_expression" : "__js_expression" }, j);
}
var jn = Qi;
function Zi(t8, e) {
  let { node: r } = t8;
...
function ea(t8) {
  return async (e, r, n, s) => {
    ...
    if (i)
      return i = St(i, (a) => typeof a == "string" ? w(!1, a, '"', "&quot;") : a), [n.node.rawName, '="', E(i), '"'];
  };
}
var Kn = Zi, Qn = new Proxy(() => {
}, { get: () => Qn }), gr = Qn;
function ta(t8) {
...
function bt(t8, e) {
  if (gr(!t8.isSelfClosing), Xn(t8, e))
    return "";
  switch (t8.type) {
    case "ieConditionalComment":
      return "<!";
...
function ia(t8, e, r) {
  ...
  let s = ((m = n.prev) == null ? void 0 : m.type) === "comment" && sa(n.prev.value), i = typeof s == "boolean" ? () => s : Array.isArray(s) ? (g) => s.includes(g.rawName) : () => !1, a = t8.map(({ node: g }) => i(g) ? T(e.originalText.slice(se(g), ie(g))) : r(), "attrs"), o = n.type === "element" && n.fullName === "script" && n.attrs.length === 1 && n.attrs[0].fullName === "src" && n.children.length === 0, p = e.singleAttributePerLine && n.attrs.length > 1 && !_e(n, e) ? S : A, l = [L([o ? " " : A, M(p, a)])];
...
var kt = oa, ua = /* @__PURE__ */ new Set(["if", "else if", "for", "switch", "case"]);
function la(t8, e) {
  let { node: r } = t8;
  switch (r.type) {
    case "element":
      ...
      if (!r.isSelfClosing && vt(r, e)) {
        ...
        return n ? async (s, i) => {
          ...
          return o || (u = await s(ar(a), { parser: n, __embeddedInHtml: !0 }), o = u === ""), [z(r, e), E(rt(t8, e, i)), o ? "" : S, u, o ? "" : S, Ze(r, e), W(r, e)];
        } : void 0;
      }
      break;
    case "text":
...
function is(t8) {
  let e = ie(t8);
  return t8.type === "element" && !t8.endSourceSpan && Me(t8.children) ? Math.max(e, is(X(!1, t8.children, -1))) : e;
}
function it(t8, e, r) {
  let n = t8.node;
  if (Se(n)) {
  ...
  return t8.map((i, a) => {
    ...
    if (R(o)) {
      if (o.prev && R(o.prev)) {
        let _ = Bt(o.prev, o);
        if (_)
          return Qe(o.prev) ? [S, S, it(i, e, r)] : [_, it(i, e, r)];
      }
      return it(i, e, r);
    }
    let u = [], p = [], l = [], m = [], g = o.prev ? Bt(o.prev, o) : "", C = o.next ? Bt(o, o.next) : "";
    return g && (Qe(o.prev) ? u.push(S, S) : g === S ? u.push(S) : R(o.prev) ? p.push(g) : p.push(me("", v, { groupId: s[a - 1] }))), C && (Qe(o) ? R(o.next) && m.push(S, S) : C === S ? R(o.next) && m.push(S) : l.push(C)), [...u, E([...p, E([it(i, e, r), ...l], { id: s[a] })]), ...m];
  }, "children");
}
function as(t8, e, r) {
  let { node: n } = t8, s = [];
  ...
  let i = os(n);
  return n.children.length > 0 ? (n.firstChild.hasLeadingSpaces = !0, n.lastChild.hasTrailingSpaces = !0, s.push(L([S, qe(t8, e, r)])), i && s.push(S, "}")) : i && s.push("}"), E(s, { shouldBreak: !0 });
}
function os(t8) {
  var e, r;
...
function ma(t8) {
  let { previous: e } = t8;
  return e?.type === "angularControlFlowBlock" && !Se(e) && !os(e);
}
function us(t8, e, r) {
...
}, da = [Sa, _a, Aa, va, ya, Ta, wa, ba, xa, Da];
function Ca(t8, e) {
  for (let r of da)
    r(t8, e);
  return t8;
...
function xa(t8, e) {
  t8.walk((r) => {
    ...
    if (n) {
      ...
      for (let s of n)
        s.isLeadingSpaceSensitive = An(s, e), s.isTrailingSpaceSensitive = Dn(s, e);
...
var Ba = { preprocess: gs, print: ka, insertPragma: ns, massageAstNode: cn, embed: Jn, getVisitorKeys: ts }, ds = Ba, Cs = [{ linguistLanguageId: 146, name: "Angular", type: "markup", tmScope: "text.html.basic", aceMode: "html", codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", color: "#e34c26", aliases: ["xhtml"], extensions: [".component.html"], parsers: ["angular"], vscodeLanguageIds: ["html"], filenames: [] }, { linguistLanguageId: 146, name: "HTML", type: "markup", tmScope: "text.html.basic", aceMode: "html", codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", color: "#e34c26", aliases: ["xhtml"], extensions: [".html", ".hta", ".htm", ".html.hl", ".inc", ".xht", ".xhtml", ".mjml"], parsers: ["html"], vscodeLanguageIds: ["html"] }, { linguistLanguageId: 146, name: "Lightning Web Components", type: "markup", tmScope: "text.html.basic", aceMode: "html", codemirrorMode: "htmlmixed", codemirrorMimeType: "text/html", color: "#e34c26", aliases: ["xhtml"], extensions: [], parsers: ["lwc"], vscodeLanguageIds: ["html"], filenames: [] }, { linguistLanguageId: 391, name: "Vue", type: "markup", color: "#41b883", extensions: [".vue"], tmScope: "text.html.vue", aceMode: "html", parsers: ["vue"], vscodeLanguageIds: ["vue"] }], Ar = { bracketSpacing: { category: "Common", type: "boolean", default: !0, description: "Print spaces between brackets.", oppositeDescription: "Do not print spaces between brackets." }, singleQuote: { category: "Common", type: "boolean", default: !1, description: "Use single quotes instead of double quotes." }, proseWrap: { category: "Common", type: "choice", default: "preserve", description: "How to wrap prose.", choices: [{ value: "always", description: "Wrap prose if it exceeds the print width." }, { value: "never", description: "Do not wrap prose." }, { value: "preserve", description: "Wrap prose as-is." }] }, bracketSameLine: { category: "Common", type: "boolean", default: !1, description: "Put > of opening tags on the last line instead of on a new line." }, singleAttributePerLine: { category: "Common", type: "boolean", default: !1, description: "Enforce single attribute per line in HTML, Vue and JSX." } }, Ss = "HTML", La = { bracketSameLine: Ar.bracketSameLine, htmlWhitespaceSensitivity: { category: Ss, type: "choice", default: "css", description: "How to handle whitespaces in HTML.", choices: [{ value: "css", description: "Respect the default value of CSS display property." }, { value: "strict", description: "Whitespaces are considered sensitive." }, { value: "ignore", description: "Whitespaces are considered insensitive." }] }, singleAttributePerLine: Ar.singleAttributePerLine, vueIndentScriptAndStyle: { category: Ss, type: "boolean", default: !1, description: "Indent script and style tags in Vue files." } }, _s = La, Vr = {};
Yr(Vr, { angular: () => xo, html: () => To, lwc: () => Bo, vue: () => ko });
var Es;
(function(t8) {
...
var Dr = { name: "custom-elements" }, vr = { name: "no-errors-schema" }, J;
(function(t8) {
...
var ht = class {
  ...
  constructor(e, r, n) {
    ...
    this._cursor = n.escapedString ? new Ir(e, s) : new Kt(e, s), this._preserveLineEndings = n.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = n.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = n.tokenizeBlocks ?? !0;
    try {
      this._cursor.init();
    } catch (i) {
      this.handleError(i);
...
`);
  ...
  _tokenizeExpansionForm() {
    ...
    if (po(this._cursor.peek()) && this._isInExpansionForm())
  ...
  _endToken(e, r) {
    if (this._currentTokenStart === null)
      throw new pt("Programming error - attempted to end a token when there was no start to the token", this._currentTokenType, this._cursor.getSpan(r));
    if (this._currentTokenType === null)
      throw new pt("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
  ...
  handleError(e) {
    if (e instanceof ft && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof ht)
  ...
  _requireCharCode(e) {
    ...
    if (!this._attemptCharCode(e))
      throw this._createError(Ye(this._cursor.peek()), this._cursor.getSpan(r));
  }
  _attemptStr(e) {
    let r = e.length;
  ...
  _requireCharCodeUntilFn(e, r) {
    ...
    if (this._attemptCharCodeUntilFn(e), this._cursor.diff(n) < r)
      throw this._createError(Ye(this._cursor.peek()), this._cursor.getSpan(n));
  }
  _attemptUntilChar(e) {
  ...
  _consumePrefixAndName() {
    ...
    for (; this._cursor.peek() !== 58 && !uo(this._cursor.peek()); )
      this._cursor.advance();
    let n;
  ...
  _consumeTagOpen(e) {
    ...
    try {
      if (!Ft(this._cursor.peek()))
        throw this._createError(Ye(this._cursor.peek()), this._cursor.getSpan(e));
...
var Kt = class t3 {
  ...
  processEscapeSequence() {
    ...
    if (e() === 92)
      if (this.internalState = { ...this.state }, this.advanceState(this.internalState), e() === 110)
        ...
        Sr(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
  }
  decodeHexDigits(e, r) {
    let n = this.input.slice(e.internalState.offset, e.internalState.offset + r), s = parseInt(n, 16);
    if (isNaN(s))
      throw e.state = e.internalState, new ft("Invalid hexadecimal escape sequence", e);
    return s;
  }
}, ft = class {
  constructor(e, r) {
  ...
  parse(e, r, n, s = !1, i) {
    ...
    } : u, n), g = n && n.canSelfClose || !1, C = n && n.allowHtmComponentClosingTags || !1, _ = new Mr(m.tokens, o, g, C, s);
  ...
  build() {
    ...
    for (let e of this._containerStack)
      e instanceof Z && this.errors.push($.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
  }
  _advance() {
    let e = this._peek;
...
`) {
  ...
  _popContainer(e, r, n) {
    ...
    for (let i = this._containerStack.length - 1; i >= 0; i--) {
      ...
      if (Ue(a.name) ? a.name === e : (e == null || a.name.toLowerCase() === e.toLowerCase()) && a instanceof r)
  ...
  _consumeIncompleteBlock(e) {
    ...
    let n = this._peek.sourceSpan.fullStart, s = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), i = new f(e.sourceSpan.start, n, e.sourceSpan.fullStart), a = new Z(e.parts[0], r, [], s, i);
    this._pushContainer(a, !1), this._popContainer(null, Z, null), this.errors.push($.create(e.parts[0], s, `Incomplete block "${e.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
  }
  _getContainer() {
...
}, qr = null, mo = () => (qr || (qr = new Xt()), qr);
function Hr(t8, e = {}) {
  let { canSelfClose: r = !1, allowHtmComponentClosingTags: n = !1, isTagNameCaseSensitive: s = !1, getTagContentType: i, tokenizeAngularBlocks: a = !1 } = e;
  return mo().parse(t8, "angular-html-parser", { tokenizeExpansionForms: a, interpolationConfig: void 0, canSelfClose: r, allowHtmComponentClosingTags: n, tokenizeBlocks: a }, s, i);
}
function go(t8, e) {
  let r = new SyntaxError(t8 + " (" + e.loc.start.line + ":" + e.loc.start.column + ")");
  return Object.assign(r, e);
}
var Vs = go, Co = new RegExp("^(?<startDelimiter>-{3}|\\+{3})(?<language>[^\\n]*)\\n(?:|(?<value>.*?)\\n)(?<endDelimiter>\\k<startDelimiter>|\\.{3})[^\\S\\n]*(?:\\n|$)", "s");
function So(t8) {
  let e = t8.match(Co);
  if (!e)
    return { content: t8 };
...
var Us = So, Jt = { attrs: !0, children: !0, cases: !0, expression: !0 }, Ws = /* @__PURE__ */ new Set(["parent"]), Zt = class t7 {
  constructor(e = {}) {
...
var Eo = [{ regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: Ao }, { regex: /^\[if([^\]]*)]><!$/, parse: Do }, { regex: /^<!\s*\[endif]$/, parse: vo }];
function zs(t8, e) {
  if (t8.value)
    for (let { regex: r, parse: n } of Eo) {
...
function js(t8, e, r) {
  let { name: n, canSelfClose: s = !0, normalizeTagName: i = !1, normalizeAttributeName: a = !1, allowHtmComponentClosingTags: o = !1, isTagNameCaseSensitive: u = !1, shouldParseAsRawText: p } = e, { rootNodes: l, errors: m } = Hr(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u, getTagContentType: p ? (...c) => p(...c) ? N.RAW_TEXT : void 0 : void 0, tokenizeAngularBlocks: n === "angular" ? !0 : void 0 });
  if (n === "vue") {
    if (l.some((b) => b.type === "docType" && b.value === "html" || b.type === "element" && b.name.toLowerCase() === "html"))
      return js(t8, Qs, r);
    let d, y = () => d ?? (d = Hr(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u })), O = (b) => y().rootNodes.find(({ startSourceSpan: V }) => V && V.start.offset === b.startSourceSpan.start.offset) ?? b;
  ...
  let g = (c) => {
    ...
    if (c.type === "element" && (i && (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || de(c)) && (c.name = _(c.name, (d) => Gs.has(d))), a))
      for (let d of c.attrs)
        d.namespace || (d.name = _(d.name, (y) => er.has(c.name) && (er.get("*").has(y) || er.get(c.name).has(y))));
  }, I = (c) => {
...
function Ks(t8, e, r = {}, n = !0) {
  let { frontMatter: s, content: i } = n ? Us(t8) : { frontMatter: null, content: t8 }, a = new we(t8, r.filepath), o = new ae(a, 0, 0, 0), u = o.moveBy(t8.length), p = { type: "root", sourceSpan: new f(o, u), children: js(i, e, r) };
  if (s) {
    let g = new ae(a, 0, 0, 0), C = g.moveBy(s.raw.length);
    s.sourceSpan = new f(g, C), p.children.unshift(s);
  }
  let l = new Zt(p), m = (g, C) => {
    let { offset: _ } = C, D = w(!1, t8.slice(0, _), /[^\n\r]/g, " "), B = Ks(D + g, e, r, !1);
...
function tr(t8) {
  return { parse: (e, r) => Ks(e, t8, r), hasPragma: rs, astFormat: "html", locStart: se, locEnd: ie };
}
var Qs = { name: "html", normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 }, To = tr(Qs), xo = tr({ name: "angular" }), ko = tr({ name: "vue", isTagNameCaseSensitive: !0, shouldParseAsRawText(t8, e, r, n) {
  return t8.toLowerCase() !== "html" && !r && (t8 !== "template" || n.some(({ name: s, value: i }) => s === "lang" && i !== "html" && i !== "" && i !== void 0));
} }), Bo = tr({ name: "lwc", canSelfClose: !1 }), Lo = { html: ds }, xh = Ur;
exports.default = xh;
