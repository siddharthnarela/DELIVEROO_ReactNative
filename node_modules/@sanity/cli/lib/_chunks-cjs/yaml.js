"use strict";
var Li = Object.create, nn = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, Ti = Object.getOwnPropertyNames, Ci = Object.getPrototypeOf, Mi = Object.prototype.hasOwnProperty, ee = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), nr = (t, e) => {
  for (var n in e)
    nn(t, n, { get: e[n], enumerable: !0 });
}, ki = (t, e, n, r) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let s of Ti(e))
      !Mi.call(t, s) && s !== n && nn(t, s, { get: () => e[s], enumerable: !(r = Ai(e, s)) || r.enumerable });
  return t;
}, rr = (t, e, n) => (n = t != null ? Li(Ci(t)) : {}, ki(e || !t || !t.__esModule ? nn(n, "default", { value: t, enumerable: !0 }) : n, t)), le = ee((U) => {
...
`);
    for (; n !== -1; )
      n += 1, e.push(n), n = t.indexOf(`
`, n);
    return e;
  }
  function Is(t) {
    let e, n;
    return typeof t == "string" ? (e = vs(t), n = t) : (Array.isArray(t) && (t = t[0]), t && t.context && (t.lineStarts || (t.lineStarts = vs(t.context.src)), e = t.lineStarts, n = t.context.src)), { lineStarts: e, src: n };
  }
  function An(t, e) {
    if (typeof t != "number" || t < 0)
      return null;
    let { lineStarts: n, src: r } = Is(e);
    if (!n || !r || t > r.length)
      return null;
    for (let i = 0; i < n.length; ++i) {
      let o = n[i];
      if (t < o)
        return { line: i, col: t - n[i - 1] + 1 };
      if (t === o)
...
` && (i = t.endOfLine(s, n, r)), this.valueRange = new Ye(n, i), i = se.endOfWhiteSpace(s, i), i = this.parseComment(i), (!this.hasComment || this.valueRange.isEmpty()) && (i = this.parseBlockValue(i)), i;
  ...
  U.Char = re, U.Node = se, U.PlainValue = kn, U.Range = Ye, U.Type = lt, U.YAMLError = de, U.YAMLReferenceError = Tn, U.YAMLSemanticError = ft, U.YAMLSyntaxError = Cn, U.YAMLWarning = Mn, U._defineProperty = Co, U.defaultTagPrefix = Oo, U.defaultTags = Lo;
}), _s = ee((Ps) => {
  ...
  function vn(t) {
    ...
    for (let o = n - 1; o >= 0; --o) {
      ...
      if (a.type === u.Type.COMMENT) {
        ...
        if (c > 0 && a.range.start >= l + c)
          break;
        r = o;
      } else if (a.type === u.Type.BLANK_LINE)
        r = o;
      else
        break;
    }
    ...
    for (; e.range.end = i, e.valueRange && e.valueRange.end > i && (e.valueRange.end = i), e !== t; )
      e = e.context.parent;
    return s;
  }
...
` && !m) {
            ...
            if (c < i + a && !t.nextContentHasIndent(s, c, a))
              return c;
            let h = new ye();
...
` && (i = n), o = s[n - 1];
      ...
      let c = r + this.blockIndent, l = this.type === u.Type.BLOCK_FOLDED, f = !0, m = "", d = "", y = !1;
      for (let h = e; h < n; ++h) {
...
`) {
          ...
          o += c, a += 1, i[a] !== "'" && e.push(new u.YAMLSyntaxError(this, "Unescaped single quote? This should not happen."));
        else if (c === " " || c === "	") {
          let l = a, f = i[a + 1];
          for (; f === " " || f === "	"; )
            a += 1, f = i[a + 1];
...
` + n.replace(/^/gm, `${e || ""}#`) : t;
  ...
  function ue(t, e, n) {
    if (Array.isArray(t))
      return t.map((r, s) => ue(r, String(s), n));
  ...
  var Ys = (t) => t == null || typeof t == "object" && t[Symbol.iterator]().next().done, W = class t extends V {
    ...
    toString(e, { blockItem: n, flowChars: r, isMap: s, itemIndent: i }, o, a) {
      ...
      let y = !1, h = !1, g = this.items.reduce((C, L, M) => {
        let A;
        L && (!y && L.spaceBefore && C.push({ type: "comment", str: "" }), L.commentBefore && L.commentBefore.match(/^.*$/gm).forEach((Oi) => {
...
`) && (h = !0), m && M < this.items.length - 1 && (_ += ","), _ = Be(_, i, A), y && (A || m) && (y = !1), C.push({ type: "item", str: _ }), C;
      }, []), w;
      if (g.length === 0)
        w = r.start + r.end;
      else if (m) {
...
` + this.comment.replace(/^/gm, `${c}#`), o && o()) : y && a && a(), w;
  ...
  var pe = class extends W {
  ...
  }, Io = (t, e, n) => e === null ? "" : typeof e != "object" ? String(e) : t instanceof V && n && n.doc ? t.toString({ anchors: /* @__PURE__ */ Object.create(null), doc: n.doc, indent: "", indentStep: n.indentStep, inFlow: !0, inStringifyKey: !0, stringify: n.stringify }) : JSON.stringify(e), T = class t extends V {
    ...
    set commentBefore(e) {
      if (this.key == null && (this.key = new P(null)), this.key instanceof V)
    ...
    toString(e, n, r) {
      ...
      if (e.allNullValues && !o)
        return this.comment ? (w = Be(w, e.indent, this.comment), n && n()) : g && !l && r && r(), e.inFlow && !f ? w : `? ${w}`;
      w = f ? `? ${w}
...
${_}`;
        ...
        c && typeof c == "object" && (c = m.schema.createNode(c, !0));
...
` && (A = ""), g && !L && r && r(), Be(w + A + M, e.indent, L);
  ...
  var mt = class extends W {
    ...
    addToJSMap(e, n) {
      for (let { source: r } of this.value.items) {
        ...
        for (let [i, o] of s)
          n instanceof Map ? n.has(i) || n.set(i, o) : n instanceof Set ? n.add(i) : Object.prototype.hasOwnProperty.call(n, i) || Object.defineProperty(n, i, { value: o, writable: !0, enumerable: !0, configurable: !0 });
      }
      return n;
    }
    toString(e, n) {
  ...
  }, Po = { defaultType: p.Type.BLOCK_LITERAL, lineWidth: 76 }, _o = { trueStr: "true", falseStr: "false" }, xo = { asBigInt: !1 }, Ro = { nullStr: "null" }, be = { defaultType: p.Type.PLAIN, doubleQuoted: { jsonEncoding: !1, minMultiLineLength: 40 }, fold: { lineWidth: 80, minContentWidth: 20 } };
  function Fn(t, e, n) {
...
`) {
  ...
  function Se(t, e) {
    ...
    for (let l = 0, f = i[l]; f; f = i[++l])
      if (f === " " && i[l + 1] === "\\" && i[l + 2] === "n" && (a += i.slice(c, l) + "\\ ", l += 1, c = l, f = "\\"), f === "\\")
        switch (i[l + 1]) {
          case "u":
            {
              a += i.slice(c, l);
...
${n}`) + "'";
  ...
  function Kt({ comment: t, type: e, value: n }, r, s, i) {
    if (/\n[\t ]+$/.test(n) || /^\s*$/.test(n))
      return Se(n, r);
    let o = r.indent || (r.forceBlockIndent || jt(n) ? "  " : ""), a = o ? "2" : "1", c = e === p.Type.BLOCK_FOLDED ? !1 : e === p.Type.BLOCK_LITERAL ? !0 : !Do(n, be.fold.lineWidth, o.length), l = c ? "|" : ">";
    if (!n)
      return l + `
`;
    let f = "", m = "";
...
` + s : t.comment = s);
  ...
  function Fo(t, e) {
    ...
    if (n === "!" && (t.version || t.options.version) === "1.0") {
      if (r[0] === "^")
        return t.warnings.push(new p.YAMLWarning(e, "YAML 1.0 ^ tag expansion is not supported")), r;
      if (/[:/]/.test(r)) {
  ...
  function Wo(t, e) {
    let n = { before: [], after: [] }, r = !1, s = !1, i = Vo(e.context.parent) ? e.context.parent.props.concat(e.props) : e.props;
  ...
  function ea(t, e) {
    ...
    for (let l = 0; l < e.items.length; ++l) {
      ...
      if (typeof f.char == "string") {
        ...
        if (m !== ":" && (s || i !== void 0) && (s && i === void 0 && (i = a ? r.pop() : null), r.push(new T(i)), s = !1, i = void 0, o = null), m === a)
          a = null;
        else if (!a && m === "?")
          s = !0;
...
`) {
      ...
      } else if (f.type === p.Type.BLANK_LINE)
        n.push({ before: r.length });
    ...
    return qs(t.errors, e), i !== void 0 && r.push(new T(i)), { comments: n, items: r };
  }
  k.Alias = we, k.Collection = W, k.Merge = Vt, k.Node = V, k.Pair = T, k.Scalar = P, k.YAMLMap = mt, k.YAMLSeq = pe, k.addComment = Be, k.binaryOptions = Po, k.boolOptions = _o, k.findPair = pt, k.intOptions = xo, k.isEmptyPath = Ys, k.nullOptions = Ro, k.resolveMap = Qo, k.resolveNode = me, k.resolveSeq = zo, k.resolveString = Un, k.strOptions = be, k.stringifyNumber = $o, k.stringifyString = Bo, k.toJSON = ue;
}), jn = ee((z) => {
  var j = le(), O = $e(), ta = { identify: (t) => t instanceof Uint8Array, default: !1, tag: "tag:yaml.org,2002:binary", resolve: (t, e) => {
...
${i.comment}` : s.comment), s = i;
  ...
  var na = { default: !1, tag: "tag:yaml.org,2002:pairs", resolve: js, createNode: Qs }, Fe = class t extends O.YAMLSeq {
    constructor() {
  ...
  var ia = { identify: (t) => t instanceof Map, nodeClass: Fe, default: !1, tag: "tag:yaml.org,2002:omap", resolve: ra, createNode: sa }, qe = class t extends O.YAMLMap {
    constructor() {
  ...
  function aa(t, e, n) {
    let r = new qe();
    for (let s of e)
      r.items.push(t.createPair(s, null, n));
    return r;
  }
  var ca = { identify: (t) => t instanceof Set, nodeClass: qe, default: !1, tag: "tag:yaml.org,2002:set", resolve: oa, createNode: aa }, Kn = (t, e) => {
    let n = e.split(":").reduce((r, s) => r * 60 + Number(s), 0);
    return t === "-" ? -n : n;
  }, Js = ({ value: t }) => {
    if (isNaN(t) || !isFinite(t))
      return O.stringifyNumber(t);
    let e = "";
    t < 0 && (e = "-", t = Math.abs(t));
    let n = [t % 60];
  ...
  }, la = { identify: (t) => typeof t == "number", default: !0, tag: "tag:yaml.org,2002:int", format: "TIME", test: /^([-+]?)([0-9][0-9_]*(?::[0-5]?[0-9])+)$/, resolve: (t, e, n) => Kn(e, n.replace(/_/g, "")), stringify: Js }, fa = { identify: (t) => typeof t == "number", default: !0, tag: "tag:yaml.org,2002:float", format: "TIME", test: /^([-+]?)([0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*)$/, resolve: (t, e, n) => Kn(e, n.replace(/_/g, "")), stringify: Js }, ua = { identify: (t) => t instanceof Date, default: !0, tag: "tag:yaml.org,2002:timestamp", test: RegExp("^(?:([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?)$"), resolve: (t, e, n, r, s, i, o, a, c) => {
    a && (a = (a + "00").substr(1, 3));
  ...
  z.binary = ta, z.floatTime = fa, z.intTime = la, z.omap = ia, z.pairs = na, z.set = ca, z.timestamp = ua, z.warn = Wn, z.warnFileDeprecation = pa, z.warnOptionDeprecation = ma;
}), Hn = ee((ai) => {
  var Gt = le(), E = $e(), D = jn();
  function ha(t, e, n) {
    ...
    if (e instanceof Map)
      for (let [s, i] of e)
        r.items.push(t.createPair(s, i, n));
    else if (e && typeof e == "object")
      for (let s of Object.keys(e))
        r.items.push(t.createPair(s, e[s], n));
    return typeof t.sortMapEntries == "function" && r.items.sort(t.sortMapEntries), r;
  }
  var gt = { createNode: ha, default: !0, nodeClass: E.YAMLMap, tag: "tag:yaml.org,2002:map", resolve: E.resolveMap };
  function ga(t, e, n) {
  ...
  var Ht = { createNode: ga, default: !0, nodeClass: E.YAMLSeq, tag: "tag:yaml.org,2002:seq", resolve: E.resolveSeq }, da = { identify: (t) => typeof t == "string", default: !0, tag: "tag:yaml.org,2002:str", resolve: E.resolveString, stringify(t, e, n, r) {
  ...
  var Ea = Jn.concat([{ identify: (t) => t == null, createNode: (t, e, n) => n.wrapScalars ? new E.Scalar(null) : null, default: !0, tag: "tag:yaml.org,2002:null", test: /^(?:~|[Nn]ull|NULL)?$/, resolve: () => null, options: E.nullOptions, stringify: () => E.nullOptions.nullStr }, { identify: (t) => typeof t == "boolean", default: !0, tag: "tag:yaml.org,2002:bool", test: /^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/, resolve: () => !0, options: E.boolOptions, stringify: Hs }, { identify: (t) => typeof t == "boolean", default: !0, tag: "tag:yaml.org,2002:bool", test: /^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/i, resolve: () => !1, options: E.boolOptions, stringify: Hs }, { identify: ht, default: !0, tag: "tag:yaml.org,2002:int", format: "BIN", test: /^([-+]?)0b([0-1_]+)$/, resolve: (t, e, n) => Jt(e, n, 2), stringify: (t) => Qn(t, 2, "0b") }, { identify: ht, default: !0, tag: "tag:yaml.org,2002:int", format: "OCT", test: /^([-+]?)0([0-7_]+)$/, resolve: (t, e, n) => Jt(e, n, 8), stringify: (t) => Qn(t, 8, "0") }, { identify: ht, default: !0, tag: "tag:yaml.org,2002:int", test: /^([-+]?)([0-9][0-9_]*)$/, resolve: (t, e, n) => Jt(e, n, 10), stringify: E.stringifyNumber }, { identify: ht, default: !0, tag: "tag:yaml.org,2002:int", format: "HEX", test: /^([-+]?)0x([0-9a-fA-F_]+)$/, resolve: (t, e, n) => Jt(e, n, 16), stringify: (t) => Qn(t, 16, "0x") }, { identify: (t) => typeof t == "number", default: !0, tag: "tag:yaml.org,2002:float", test: /^(?:[-+]?\.inf|(\.nan))$/i, resolve: (t, e) => e ? NaN : t[0] === "-" ? Number.NEGATIVE_INFINITY : Number.POSITIVE_INFINITY, stringify: E.stringifyNumber }, { identify: (t) => typeof t == "number", default: !0, tag: "tag:yaml.org,2002:float", format: "EXP", test: /^[-+]?([0-9][0-9_]*)?(\.[0-9_]*)?[eE][-+]?[0-9]+$/, resolve: (t) => parseFloat(t.replace(/_/g, "")), stringify: ({ value: t }) => Number(t).toExponential() }, { identify: (t) => typeof t == "number", default: !0, tag: "tag:yaml.org,2002:float", test: /^[-+]?(?:[0-9][0-9_]*)?\.([0-9_]*)$/, resolve(t, e) {
  ...
  Gt._defineProperty(dt, "defaultPrefix", Gt.defaultTagPrefix), Gt._defineProperty(dt, "defaultTags", Gt.defaultTags), ai.Schema = dt;
}), ui = ee((tn) => {
  var Y = le(), S = $e(), ci = Hn(), Aa = { anchorPrefix: "a", customTags: null, indent: 2, indentSeq: !0, keepCstNodes: !1, keepNodeTypes: !0, keepBlobsInJSON: !0, mapAsMap: !1, maxAliasCount: 100, prettyErrors: !1, simpleKeys: !1, version: "1.2" }, Ta = { get binary() {
  ...
  } }, fi = { "1.0": { schema: "yaml-1.1", merge: !0, tagPrefixes: [{ handle: "!", prefix: Y.defaultTagPrefix }, { handle: "!!", prefix: "tag:private.yaml.org,2002:" }] }, 1.1: { schema: "yaml-1.1", merge: !0, tagPrefixes: [{ handle: "!", prefix: "!" }, { handle: "!!", prefix: Y.defaultTagPrefix }] }, 1.2: { schema: "core", merge: !1, tagPrefixes: [{ handle: "!", prefix: "!" }, { handle: "!!", prefix: Y.defaultTagPrefix }] } };
  function li(t, e) {
  ...
  function va(t, e) {
    ...
    for (let i of e)
      if (i.valueRange) {
        ...
        i.comment !== null ? (r === void 0 ? n.before : n.after).push(i.comment) : i.type === Y.Type.BLANK_LINE && (s = !0, r === void 0 && n.before.length > 0 && !t.commentBefore && (t.commentBefore = n.before.join(`
`), n.before = []));
    if (t.contents = r || null, !r)
      t.comment = n.before.concat(n.after).join(`
`) || null;
    else {
      let i = n.before.join(`
`);
  ...
  var en = class t {
    ...
    toJSON(e, n) {
      ...
      if (typeof n == "function" && a.anchors)
        for (let { count: f, res: m } of a.anchors.values())
          n(m, f);
      return l;
    }
    toString() {
      ...
      let i = { anchors: /* @__PURE__ */ Object.create(null), doc: this, indent: "", indentStep: " ".repeat(e), stringify: zt }, o = !1, a = null;
      if (this.contents) {
        ...
        let c = a ? null : () => o = !0, l = zt(this.contents, i, () => a = null, c);
...
`;
  ...
  Y._defineProperty(en, "defaults", fi), tn.Document = en, tn.defaultOptions = Aa, tn.scalarOptions = Ta;
}), hi = ee((mi) => {
  ...
  var qa = { createNode: Ya, defaultOptions: Ne.defaultOptions, Document: Ke, parse: $a, parseAllDocuments: Ba, parseCST: zn.parse, parseDocument: pi, scalarOptions: Ne.scalarOptions, stringify: Fa };
  mi.YAML = qa;
}), di = ee((Rm, gi) => {
  gi.exports = hi().YAML;
}), yi = ee((Q) => {
  var Ve = $e(), We = le();
  Q.findPair = Ve.findPair, Q.parseMap = Ve.resolveMap, Q.parseSeq = Ve.resolveSeq, Q.stringifyNumber = Ve.stringifyNumber, Q.stringifyString = Ve.stringifyString, Q.toJSON = Ve.toJSON, Q.Type = We.Type, Q.YAMLError = We.YAMLError, Q.YAMLReferenceError = We.YAMLReferenceError, Q.YAMLSemanticError = We.YAMLSemanticError, Q.YAMLSyntaxError = We.YAMLSyntaxError, Q.YAMLWarning = We.YAMLWarning;
}), tr = {};
nr(tr, { languages: () => Ir, options: () => Pr, parsers: () => er, printers: () => Ja });
var vi = (t, e, n, r) => {
  if (!(t && e == null))
    return e.replaceAll ? e.replaceAll(n, r) : n.global ? e.replace(n, r) : e.split(n).join(r);
}, yt = vi, je = "string", Qe = "array", Je = "cursor", Ge = "indent", Oe = "align", He = "trim", Le = "group", Ae = "fill", Te = "if-break", Xe = "indent-if-break", Ce = "line-suffix", ze = "line-suffix-boundary", te = "line", Ze = "label", Me = "break-parent", Et = /* @__PURE__ */ new Set([Je, Ge, Oe, He, Le, Ae, Te, Xe, Ce, ze, te, Ze, Me]);
function Ii(t) {
  if (typeof t == "string")
    return je;
  if (Array.isArray(t))
...
var et = Ii, Pi = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function _i(t) {
...
function ke(t, e = {}) {
  return { type: Le, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function on(t) {
...
var bt = { type: Me }, xi = { type: te, hard: !0 }, Ri = { type: te, hard: !0, literal: !0 }, ne = { type: te }, Nt = { type: te, soft: !0 }, N = [xi, bt], rt = [Ri, bt];
function v(t, e) {
  let n = [];
  for (let r = 0; r < e.length; r++)
    r !== 0 && n.push(t), n.push(e[r]);
  return n;
}
var Di = (t, e, n) => {
  if (!(t && e == null))
...
function $i(t, e) {
  let n = e - 1;
  n = cn(t, n, { backwards: !0 }), n = ln(t, n, { backwards: !0 }), n = cn(t, n, { backwards: !0 });
  let r = ln(t, n, { backwards: !0 });
  return n !== r;
}
var lr = $i, fn = class extends Error {
...
function ur(t, e) {
  let { node: n } = t;
  if (n.type === "root" && e.filepath && /(?:[/\\]|^)\.(?:prettier|stylelint|lintstaged)rc$/.test(e.filepath))
    return async (r) => {
...
var Ie = Vi;
function G(t, e) {
  return typeof t?.type == "string" && (!e || e.includes(t.type));
}
function pn(t, e, n) {
...
function Z(t) {
  return Ie(t?.leadingComments);
}
function ie(t) {
  return Ie(t?.middleComments);
}
function mn(t) {
...
`).map((c) => c.slice(i));
  ...
  function a(c) {
    ...
    let l = 0;
    for (let f = c.length - 1; f >= 0 && c[f].length === 0; f--)
      l++;
...
function ji(t, e, n) {
  ...
  for (let [l, f] of a.entries())
    l === 0 && c.push(N), c.push(wt(v(ne, f))), l !== a.length - 1 ? c.push(f.length === 0 ? N : ir(rt)) : r.chomping === "keep" && i && c.push(on(f.length === 0 ? N : rt));
...
function Ct(t, e, n) {
  ...
  let c = x(!1, r.children, -1), l = c?.type === "flowMappingItem" && _e(c.key) && _e(c.value);
...
function Ji(t, e, n) {
  ...
  let l = e("key"), f = Gi(r) ? " " : "";
  if (c)
    return r.type === "flowMappingItem" && s.type === "flowMapping" ? l : r.type === "mappingItem" && dn(i.content, n) && !H(i.content) && ((C = s.tag) == null ? void 0 : C.value) !== "tag:yaml.org,2002:set" ? [l, f, ":"] : ["? ", I(2, l)];
  let m = e("value");
  if (a)
    return [": ", I(2, m)];
  if (Z(o) || !ot(i.content))
    return ["? ", I(2, l), N, ...t.map(() => [e(), N], "value", "leadingComments"), ": ", I(2, m)];
  if (Hi(i.content) && !Z(i.content) && !ie(i.content) && !H(i.content) && !R(i) && !Z(o.content) && !ie(o.content) && !R(o) && dn(o.content, n))
    return [l, f, ": ", m];
...
function dn(t, e) {
  ...
  if (/\\$/m.test(e.originalText.slice(t.position.start.offset, t.position.end.offset)))
    return !1;
  switch (e.proseWrap) {
    case "never":
...
function eo(t, e, n) {
  ...
  switch (r.type) {
    ...
    case "quoteSingle": {
      ...
      if (o.includes(i))
        return [s, at(r.type, r.type === "quoteDouble" ? yt(!1, yt(!1, o, '\\"', i), "'", s.repeat(2)) : o, e), s];
      if (o.includes(s))
...
function no(t, e) {
  let n = t.node;
  if (t.isFirst && /---(?:\s|$)/.test(e.originalText.slice(ve(n), ve(n) + 4)) || n.head.children.length > 0 || R(n.head) || H(n.head))
    return "head";
  let r = t.next;
...
function ao(t, e, n) {
  ...
  if (s) {
    if (s.trailingComment)
      throw new Error(`Unexpected multiple trailing comment at ${ge(t.position.start)}`);
...
function co(t, e) {
  if (t.position.start.offset < e.position.start.offset && t.position.end.offset > e.position.end.offset)
    switch (t.type) {
      case "flowMapping":
      case "flowSequence":
        return t.children.length === 0 || e.position.start.line > t.children[t.children.length - 1].position.end.line;
    }
  if (e.position.end.offset < t.position.end.offset)
    return !1;
  switch (t.type) {
    case "sequenceItem":
...
function Fr(t, e) {
  let n = t.cstNode;
  return $r(e.transformRange({ origStart: n.valueRange.origStart - 1, origEnd: n.valueRange.origEnd }), e.transformContent(t), n.rawValue);
}
function qr(t) {
...
function It(t, e) {
  let n = t.cstNode, r = 1, s = n.chomping === "CLIP" ? 0 : 1, o = n.header.origEnd - n.header.origStart - r - s !== 0, a = e.transformRange({ origStart: n.header.origStart, origEnd: n.valueRange.origEnd }), c = null, l = vt(t, e, (f) => {
    if (!(a.start.offset < f.position.start.offset && f.position.end.offset < a.end.offset))
      return !1;
    if (c)
      throw new Error(`Unexpected multiple indicator comments at ${ge(f.position.start)}`);
    return c = f, !0;
  });
...
function es(t, e, n) {
  ...
  return e.comments.push(...s, ...i), { documentBody: Zr(l, c, i), documentEndPoint: f, documentTrailingComment: o, documentHeadTrailingComment: a };
}
function lo(t, e, n) {
  let r = [], s = [], i = [], o = [], a = !1;
  ...
  if (i.length > 1)
    throw new Error(`Unexpected multiple document trailing comments at ${ge(i[1].position.start)}`);
  if (o.length > 1)
    throw new Error(`Unexpected multiple documentHead trailing comments at ${ge(o[1].position.start)}`);
...
function ns(t, e) {
  ...
  return e.comments.push(...s, ...i), { createDocumentHeadWithTrailingComment: (l) => (l && e.comments.push(l), ts(o, r, i, l)), documentHeadEndMarkerPoint: a };
}
function uo(t, e) {
  let n = [], r = [], s = [], i = !1;
...
function rs(t, e) {
  let { createDocumentHeadWithTrailingComment: n, documentHeadEndMarkerPoint: r } = ns(t, e), { documentBody: s, documentEndPoint: i, documentTrailingComment: o, documentHeadTrailingComment: a } = es(t, e, r), c = n(a);
...
function is(t, e) {
  ...
  return ss(e.transformRange({ origStart: i.origOffset, origEnd: o.origOffset + 1 }), e.transformContent(t), s);
}
function os(t, e, n) {
...
function hs(t, e) {
  let n = t.cstNode;
  return ps(e.transformRange({ origStart: n.valueRange.origStart, origEnd: ms(e.text, n.valueRange.origEnd - 1, /\S/) + 1 }), e.transformContent(t), n.strValue);
}
function gs(t) {
...
function Os(t, e) {
  if (t === null || t.type === void 0 && t.value === null)
    return null;
  switch (t.type) {
    case "ALIAS":
      return Fr(t, e);
...
function ks(t) {
  if (!t.setOrigRanges()) {
    let e = (n) => {
      if (ho(n))
        return n.origStart = n.start, n.origEnd = n.end, !0;
      if (go(n))
        return n.origOffset = n.offset, !0;
    };
    t.forEach((n) => bn(n, e));
  }
}
...
var Ei = rr(di(), 1), J = rr(yi(), 1), Zn = J.default.YAMLSemanticError, { Document: Si, parseCST: wi } = Ei.default;
function bi(t) {
  let e = wi(t);
  ks(e);
  let n = e.map((a) => new Si({ merge: !1, keepCstNodes: !0 }).parse(a)), r = new xr(t), s = [], i = { text: t, locator: r, comments: s, transformOffset: (a) => Cs(a, i), transformRange: (a) => Ms(a, i), transformNode: (a) => Os(a, i), transformContent: (a) => vt(a, i) };
  for (let a of n)
    for (let c of a.errors)
      if (!(c instanceof Zn && c.message === 'Map keys must be unique; "<<" is repeated'))
        throw As(c, i);
  n.forEach((a) => ct(a.cstNode));
  let o = Br(i.transformRange({ origStart: 0, origEnd: i.text.length }), n.map(i.transformNode), s);
...
function ja(t) {
  try {
    ...
    throw e != null && e.position ? Ni(e.message, { loc: e.position, cause: e }) : e;
  }
}
var Qa = { astFormat: "yaml", parse: ja, hasPragma: Er, locStart: ve, locEnd: dr }, Ja = { yaml: vr }, yh = tr;
exports.default = yh;
