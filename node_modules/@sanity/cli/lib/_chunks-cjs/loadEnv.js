"use strict";
var require$$1 = require("get-it"), require$$2 = require("get-it/middleware"), require$$0$2 = require("fs"), path$1 = require("path"), tty = require("tty"), require$$0$1 = require("util"), require$$0 = require("os"), fs$1 = require("node:fs"), path$2 = require("node:path"), require$$3 = require("crypto");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var require$$0__default$2 = /* @__PURE__ */ _interopDefaultCompat(require$$0$2), path__default = /* @__PURE__ */ _interopDefaultCompat(path$1), tty__default = /* @__PURE__ */ _interopDefaultCompat(tty), require$$0__default$1 = /* @__PURE__ */ _interopDefaultCompat(require$$0$1), require$$0__default = /* @__PURE__ */ _interopDefaultCompat(require$$0), fs__default = /* @__PURE__ */ _interopDefaultCompat(fs$1), path__default$1 = /* @__PURE__ */ _interopDefaultCompat(path$2), require$$3__default = /* @__PURE__ */ _interopDefaultCompat(require$$3), extendStatics = function(d, b) {
...
], exp = defineCreateClientExports(middleware, SanityClient), requester = exp.requester, createClient = exp.createClient;
...
function getAugmentedNamespace(n) {
  ...
  if (typeof f2 == "function") {
    var a = function a2() {
      return this instanceof a2 ? Reflect.construct(f2, arguments, this.constructor) : f2.apply(this, arguments);
    };
...
function requireSupportsColor() {
  ...
  const os2 = require$$0__default.default, hasFlag2 = requireHasFlag(), env = process.env;
  let forceColor;
...
function isSanityV2StudioRoot(basePath) {
  try {
    const content = require$$0__default$2.default.readFileSync(path__default.default.join(basePath, "sanity.json"), "utf8"), isRoot = !!JSON.parse(content)?.root;
...
const fs = require$$0__default$2.default, path = path__default.default, os = require$$0__default.default, crypto = require$$3__default.default, packageJson = require$$4, version = packageJson.version, LINE = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
function parse(src2) {
  const obj = {};
