"use strict";
var ul = Object.create, $r = Object.defineProperty, ll = Object.getOwnPropertyDescriptor, cl = Object.getOwnPropertyNames, fl = Object.getPrototypeOf, pl = Object.prototype.hasOwnProperty, y = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), en = (t, e) => {
  for (var s in e)
    $r(t, s, { get: e[s], enumerable: !0 });
}, hl = (t, e, s, r) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let n of cl(e))
      !pl.call(t, n) && n !== s && $r(t, n, { get: () => e[n], enumerable: !(r = ll(e, n)) || r.enumerable });
  return t;
}, ue = (t, e, s) => (s = t != null ? ul(fl(t)) : {}, hl(e || !t || !t.__esModule ? $r(s, "default", { value: t, enumerable: !0 }) : s, t)), On = y((pe) => {
  Object.defineProperty(pe, "__esModule", { value: !0 }), pe.extract = $l, pe.parse = zl, pe.parseWithComments = An, pe.print = Yl, pe.strip = Wl;
  var Dl = /\*\/$/, Ml = /^\/\*\*?/, Tn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/, Bl = /(^|\s+)\/\/([^\r\n]*)/g, kn = /^(\r?\n)+/, Ul = /(?:^|\r?\n) *(@[^\r\n]*?) *\r?\n *(?![^@\r\n]*\/\/[^]*)([^@\r\n\s][^@\r\n]+?) *\r?\n/g, En = /(?:^|\r?\n) *@(\S+) *([^\r\n]*)/g, Fl = /(\r?\n|^) *\* ?/g, Cn = [];
  function $l(t) {
    let e = t.match(Tn);
...
`;
    ...
    let s = "";
    for (; s !== t; )
      s = t, t = t.replace(Ul, `${e}$1 $2${e}`);
    t = t.replace(kn, "").trimRight();
    let r = /* @__PURE__ */ Object.create(null), n = t.replace(En, "").replace(kn, "").trimRight(), i;
    for (; i = En.exec(t); ) {
  ...
  function Yl({ comments: t = "", pragmas: e = {} }) {
    let s = `
`, r = "/**", n = " *", i = " */", o = Object.keys(e), a = o.flatMap((c) => Sn(c, e[c])).map((c) => `${n} ${c}${s}`).join("");
    if (!t) {
      if (o.length === 0)
        return "";
      if (o.length === 1 && !Array.isArray(e[o[0]])) {
        let c = e[o[0]];
        return `${r} ${Sn(o[0], c)[0]}${i}`;
      }
    }
  ...
  function Sn(t, e) {
    return Cn.concat(e).map((s) => `@${t} ${s}`.trim());
  }
}), $t = y((iv, ss) => {
  ss.exports.isClean = Symbol("isClean"), ss.exports.my = Symbol("my");
}), gi = y((ov, ns) => {
  var S = String, yi = function() {
  ...
  ns.exports = yi(), ns.exports.createColors = yi;
}), is = y(() => {
}), Wt = y((lv, xi) => {
  var wi = gi(), vi = is(), nt = class t extends Error {
...
`)) {
    ...
    body(e) {
      ...
      for (; s > 0 && e.nodes[s].type === "comment"; )
        s -= 1;
    ...
    raw(e, s, r) {
      let n;
      if (r || (r = s), s && (n = e.raws[s], typeof n < "u"))
        return n;
      let i = e.parent;
    ...
    rawBeforeClose(e) {
      ...
      return e.walk((r) => {
        if (r.nodes && r.nodes.length > 0 && typeof r.raws.after < "u")
          return s = r.raws.after, s.includes(`
`) && (s = s.replace(/[^\n]+$/, "")), !1;
      }), s && (s = s.replace(/\S/g, "")), s;
    }
...
`);
    ...
    rawSemicolon(e) {
      let s;
      return e.walk((r) => {
        if (r.nodes && r.nodes.length && r.last.type === "decl" && (s = r.raws.semicolon, typeof s < "u"))
          return !1;
      }), s;
    }
    rawValue(e, s) {
  ...
  bi.exports = it, it.default = it;
}), ot = y((fv, ki) => {
  var mc = zt();
  function os(t, e) {
    new mc(e).stringify(t);
  }
  ki.exports = os, os.default = os;
}), ut = y((pv, Ei) => {
  var { isClean: Yt, my: yc } = $t(), gc = Wt(), wc = zt(), vc = ot();
  function as(t, e) {
  ...
  var at = class {
    ...
    positionBy(e, s) {
      ...
      if (e.index)
        r = this.positionInside(e.index, s);
      else if (e.word) {
        s = this.toString();
...
` ? (n = 1, i += 1) : n += 1;
    ...
    rangeBy(e) {
      ...
      if (e.word) {
        ...
        e.start ? s = { column: e.start.column, line: e.start.line } : e.index && (s = this.positionInside(e.index)), e.end ? r = { column: e.end.column, line: e.end.line } : e.endIndex ? r = this.positionInside(e.endIndex) : e.index && (r = this.positionInside(e.index + 1));
    ...
    replaceWith(...e) {
      if (this.parent) {
        let s = this, r = !1;
        for (let n of e)
          n === this ? r = !0 : r ? (this.parent.insertAfter(s, n), s = n) : this.parent.insertBefore(s, n);
        r || this.remove();
      }
      return this;
    }
    ...
    toJSON(e, s) {
      ...
      for (let o in this) {
        ...
        let a = this[o];
        if (Array.isArray(a))
          r[o] = a.map((u) => typeof u == "object" && u.toJSON ? u.toJSON(null, s) : u);
  ...
  Ei.exports = at, at.default = at;
}), ct = y((hv, Si) => {
  var xc = ut(), lt = class extends xc {
    constructor(e) {
  ...
  Si.exports = lt, lt.default = lt;
}), Oe = y((dv, Ti) => {
  var _c = ut(), ft = class extends _c {
    constructor(e) {
      super(e), this.type = "comment";
    }
  };
  Ti.exports = ft, ft.default = ft;
}), ne = y((mv, Li) => {
  var { isClean: Ci, my: Ai } = $t(), Oi = ct(), Ni = Oe(), bc = ut(), Pi, us, ls, Ri;
  function Ii(t) {
    return t.map((e) => (e.nodes && (e.nodes = Ii(e.nodes)), delete e.source, e));
  }
  function qi(t) {
    if (t[Ci] = !1, t.proxyOf.nodes)
  ...
  var z = class t extends bc {
    ...
    each(e) {
      ...
      for (; this.indexes[s] < this.proxyOf.nodes.length && (r = this.indexes[s], n = e(this.proxyOf.nodes[r], r), n !== !1); )
        this.indexes[s] += 1;
  ...
  z.registerParse = (t) => {
    ...
    Ri = t;
  }, Li.exports = z, z.default = z, z.rebuild = (t) => {
  ...
  var Vt = /[\t\n\f\r "#'()/;[\\\]{}]/g, Gt = /[\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, kc = /.[\r\n"'(/\\]/, Di = /[\da-f]/i;
  Mi.exports = function(e, s = {}) {
    let r = e.css.valueOf(), n = s.ignoreErrors, i, o, a, u, c, f, p, l, g, x, h = r.length, d = 0, m = [], _ = [];
    function w() {
      return d;
    }
    function v($) {
            ...
            do {
              if (f = !1, o = r.indexOf(")", o + 1), o === -1)
                if (n || T) {
                  ...
                  v("bracket");
              for (p = o; r.charCodeAt(p - 1) === 92; )
                p -= 1, f = !f;
            } while (f);
            x = ["brackets", r.slice(d, o + 1), d, o], d = o;
          } else
            o = r.indexOf(")", d + 1), u = r.slice(d, o + 1), o === -1 || kc.test(u) ? x = ["(", "(", d] : (x = ["brackets", u, d, o], d = o);
          break;
        }
        case 39:
        case 34: {
    ...
    return { back: K, endOfFile: R, nextToken: F, position: w };
  };
}), Kt = y((gv, Ui) => {
  var Bi = ne(), Ne = class extends Bi {
    constructor(e) {
  ...
  Ui.exports = Ne, Ne.default = Ne, Bi.registerAtRule(Ne);
}), Pe = y((wv, zi) => {
  var Fi = ne(), $i, Wi, ie = class extends Fi {
    constructor(e) {
  ...
  ie.registerLazyResult = (t) => {
    ...
    Wi = t;
  }, zi.exports = ie, ie.default = ie, Fi.registerRoot(ie);
}), cs = y((vv, Yi) => {
  var pt = { comma(t) {
    return pt.split(t, [","], !0);
  }, space(t) {
...
`, "	"];
    ...
    for (let f of t)
      c ? c = !1 : f === "\\" ? c = !0 : a ? f === u && (a = !1) : f === '"' || f === "'" ? (a = !0, u = f) : f === "(" ? o += 1 : f === ")" ? o > 0 && (o -= 1) : o === 0 && e.includes(f) && (i = !0), i ? (n !== "" && r.push(n.trim()), n = "", i = !1) : n += f;
    return (s || n !== "") && r.push(n.trim()), r;
  } };
  Yi.exports = pt, pt.default = pt;
}), Qt = y((xv, Gi) => {
  var Vi = ne(), Ec = cs(), Re = class extends Vi {
    constructor(e) {
  ...
  Gi.exports = Re, Re.default = Re, Vi.registerRule(Re);
}), jt = y((_v, Qi) => {
  var Sc = ct(), Tc = Ht(), Cc = Oe(), Ac = Kt(), Oc = Pe(), Hi = Qt(), Ki = { empty: !0, space: !0 };
  function Nc(t) {
  ...
  var fs = class {
    constructor(e) {
      this.input = e, this.root = new Oc(), this.current = this.root, this.spaces = "", this.semicolon = !1, this.customProperty = !1, this.createTokenizer(), this.root.source = { input: e, start: { column: 1, line: 1, offset: 0 } };
    }
    atrule(e) {
      let s = new Ac();
    ...
    decl(e, s) {
      ...
      this.init(r, e[0][2]);
      let n = e[e.length - 1];
      for (n[0] === ";" && (this.semicolon = !0, e.pop()), r.source.end = this.getPosition(n[3] || n[2] || Nc(e)), r.source.end.offset++; e[0][0] !== "word"; )
    ...
    raw(e, s, r, n) {
      ...
      for (let l = 0; l < a; l += 1)
        i = r[l], o = i[0], o === "space" && l === a - 1 && !n ? c = !1 : o === "comment" ? (p = r[l - 1] ? r[l - 1][0] : "empty", f = r[l + 1] ? r[l + 1][0] : "empty", !Ki[p] && !Ki[f] ? u.slice(-1) === "," ? c = !1 : u += i[1] : c = !1) : u += i[1];
      if (!c) {
  ...
  var Pc = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict", Rc = (t, e = 21) => (s = e) => {
    let r = "", n = s;
    for (; n--; )
    ...
    let e = "", s = t;
    for (; s--; )
      e += Pc[Math.random() * 64 | 0];
    return e;
  };
  Ji.exports = { nanoid: Ic, customAlphabet: Rc };
}), ps = y((Sv, Zi) => {
  Zi.exports = class {
  };
}), qe = y((Cv, so) => {
  var { SourceMapConsumer: qc, SourceMapGenerator: Lc } = ji(), { fileURLToPath: eo, pathToFileURL: Jt } = {}, { isAbsolute: ms, resolve: ys } = {}, { nanoid: Dc } = Xi(), hs = is(), to = Wt(), Mc = ps(), ds = Symbol("fromOffsetCache"), Bc = !!(qc && Lc), ro = !!(ys && ms), Ie = class {
    constructor(e, s = {}) {
    ...
    error(e, s, r, n = {}) {
      ...
      return u ? i = new to(e, u.endLine === void 0 ? u.line : { column: u.column, line: u.line }, u.endLine === void 0 ? u.column : { column: u.endColumn, line: u.endLine }, u.source, u.file, n.plugin) : i = new to(e, o === void 0 ? s : { column: r, line: s }, o === void 0 ? r : { column: a, line: o }, this.css, this.file, n.plugin), i.input = { column: r, endColumn: a, endLine: o, line: s, source: this.css }, this.file && (Jt && (i.input.url = Jt(this.file).toString()), i.input.file = this.file), i;
    }
    fromOffset(e) {
      let s, r;
      if (this[ds])
...
`);
  ...
  so.exports = Ie, Ie.default = Ie, hs && hs.registerInput && hs.registerInput(Ie);
}), ht = y((Av, no) => {
  var Uc = ne(), Fc = jt(), $c = qe();
  function Xt(t, e) {
    let s = new $c(t, e), r = new Fc(s);
    try {
      r.parse();
    } catch (n) {
      throw n;
  ...
  no.exports = Xt, Xt.default = Xt, Uc.registerParse(Xt);
}), io = y((Ov, gs) => {
  var Wc = Ht(), zc = qe();
...
`));
      ...
      if (e[0] === "comment" && /^\/\*/.test(e[1]))
        return e[0] = "word", e[1] = e[1].slice(1), t[1] = "//", this.tokenizer.back(e), gs.exports.isInlineComment.bind(this)(t);
    }
    return !1;
  } };
}), ao = y((Nv, oo) => {
  oo.exports = { interpolation(t) {
  ...
  var Yc = /^#[0-9a-fA-F]{6}$|^#[0-9a-fA-F]{3}$/, Vc = /\.[0-9]/, Gc = (t) => {
    let [, e] = t, [s] = e;
    return (s === "." || s === "#") && Yc.test(e) === !1 && Vc.test(e) === !1;
  };
  uo.exports = { isMixinToken: Gc };
}), fo = y((Rv, co) => {
  var Hc = Ht(), Kc = /^url\((.+)\)/;
  co.exports = (t) => {
  ...
  var Qc = Oe(), jc = jt(), { isInlineComment: Jc } = io(), { interpolation: go } = ao(), { isMixinToken: Xc } = lo(), Zc = fo(), ef = yo(), tf = /(!\s*important)$/i;
  wo.exports = class extends jc {
    ...
    inlineComment(e) {
      ...
      if (this.init(s, e[2]), s.source.end = this.getPosition(e[3] || e[2]), s.inline = !0, s.raws.begin = "//", /^\s*$/.test(r))
        s.text = "", s.raws.left = r, s.raws.right = "";
      else {
        let n = r.match(/^(\s*)([^]*[^\s])(\s*)$/);
    ...
    mixin(e) {
      ...
      if ((n < 0 || n > 3) && i > 0) {
        let c = e.reduce((w, v, R) => v[0] === ")" ? R : w), p = e.slice(i, c + i).map((w) => w[1]).join(""), [l] = e.slice(i), g = [l[2], l[3]], [x] = e.slice(c, c + 1), h = [x[2], x[3]], d = ["brackets", p].concat(g, h), m = e.slice(0, i), _ = e.slice(c + 1);
      ...
      for (let c of e)
        if ((c[1] === "!" || a.length) && a.push(c), c[1] === "important")
          break;
      if (a.length) {
        let [c] = a, f = e.indexOf(c), p = a[a.length - 1], l = [c[2], c[3]], g = [p[4], p[5]], h = ["word", a.map((d) => d[1]).join("")].concat(l, g);
  ...
  var sf = qe(), nf = vo(), of = _o();
  ws.exports = { parse(t, e) {
    let s = new sf(t, e), r = new nf(s);
  ...
  var af = ne(), Eo, So, ye = class extends af {
    constructor(e) {
  ...
  No.exports = mt, mt.default = mt;
}), Es = y((Gv, qo) => {
  var { isClean: H, my: lf } = $t(), cf = vs(), ff = ot(), pf = ne(), hf = Zt();
  xs();
  var Po = er(), df = ht(), mf = Pe(), yf = { atrule: "AtRule", comment: "Comment", decl: "Declaration", document: "Document", root: "Root", rule: "Rule" }, gf = { AtRule: !0, AtRuleExit: !0, Comment: !0, CommentExit: !0, Declaration: !0, DeclarationExit: !0, Document: !0, DocumentExit: !0, Once: !0, OnceExit: !0, postcssPlugin: !0, prepare: !0, Root: !0, RootExit: !0, Rule: !0, RuleExit: !0 }, wf = { Once: !0, postcssPlugin: !0, prepare: !0 }, Le = 0;
  function yt(t) {
  ...
  function Ro(t) {
    let e;
    return t.type === "document" ? e = ["Document", Le, "DocumentExit"] : t.type === "root" ? e = ["Root", Le, "RootExit"] : e = Io(t), { eventIndex: 0, events: e, iterator: 0, node: t, visitorIndex: 0, visitors: [] };
  }
  function bs(t) {
  ...
  var ks = {}, oe = class t {
    constructor(e, s, r) {
      ...
      if (typeof s == "object" && s !== null && (s.type === "root" || s.type === "document"))
        n = bs(s);
      else if (s instanceof t || s instanceof Po)
        n = bs(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = !1), r.map.prev = s.map);
      else {
        let i = df;
      ...
      this.result = new Po(e, n, r), this.helpers = { ...ks, postcss: ks, result: this.result }, this.plugins = this.processor.plugins.map((i) => typeof i == "object" && i.prepare ? { ...i, ...i.prepare(this.result) } : i);
    }
    async() {
    ...
    prepareVisitors() {
      ...
      for (let s of this.plugins)
        if (typeof s == "object")
          for (let r in s) {
            if (!gf[r] && /^[A-Z]/.test(r))
              throw new Error(`Unknown event ${r} in ${s.postcssPlugin}. Try to update PostCSS (${this.processor.version} now).`);
            if (!wf[r])
              if (typeof s[r] == "object")
                for (let n in s[r])
                  n === "*" ? e(s, r, s[r][n]) : e(s, r + "-" + n.toLowerCase(), s[r][n]);
              else
                typeof s[r] == "function" && e(s, r, s[r]);
          }
  ...
  oe.registerPostcss = (t) => {
    ks = t;
  }, qo.exports = oe, oe.default = oe, mf.registerLazyResult(oe), hf.registerLazyResult(oe);
}), Do = y((Kv, Lo) => {
  var vf = vs(), xf = ot();
  xs();
  var _f = ht(), bf = er(), gt = class {
    constructor(e, s, r) {
  ...
  Lo.exports = gt, gt.default = gt;
}), Bo = y((Qv, Mo) => {
  var kf = Do(), Ef = Es(), Sf = Zt(), Tf = Pe(), ge = class {
    constructor(e = []) {
  ...
  Mo.exports = ge, ge.default = ge, Tf.registerProcessor(ge), Sf.registerProcessor(ge);
}), Fo = y((jv, Uo) => {
  var Cf = ct(), Af = ps(), Of = Oe(), Nf = Kt(), Pf = qe(), Rf = Pe(), If = Qt();
  function wt(t, e) {
    if (Array.isArray(t))
      return t.map((n) => wt(n));
    let { inputs: s, ...r } = t;
    if (s) {
      ...
      for (let n of s) {
        ...
        i.map && (i.map = { ...i.map, __proto__: Af.prototype }), e.push(i);
      }
    }
  ...
  Uo.exports = wt, wt.default = wt;
}), tr = y((Jv, Ho) => {
  var qf = Wt(), $o = ct(), Lf = Es(), Df = ne(), Ss = Bo(), Mf = ot(), Bf = Fo(), Wo = Zt(), Uf = _s(), zo = Oe(), Yo = Kt(), Ff = er(), $f = qe(), Wf = ht(), zf = cs(), Vo = Qt(), Go = Pe(), Yf = ut();
  function b(...t) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
  ...
  }, b.stringify = Mf, b.parse = Wf, b.fromJSON = Bf, b.list = zf, b.comment = (t) => new zo(t), b.atRule = (t) => new Yo(t), b.decl = (t) => new $o(t), b.rule = (t) => new Vo(t), b.root = (t) => new Go(t), b.document = (t) => new Wo(t), b.CssSyntaxError = qf, b.Declaration = $o, b.Container = Df, b.Processor = Ss, b.Document = Wo, b.Comment = zo, b.Warning = Uf, b.AtRule = Yo, b.Result = Ff, b.Input = $f, b.Rule = Vo, b.Root = Go, b.Node = Yf, Lf.registerPostcss(b), Ho.exports = b, b.default = b;
}), Qo = y((Xv, Ko) => {
  var { Container: Vf } = tr(), Ts = class extends Vf {
    constructor(e) {
  ...
  var rr = /[\t\n\f\r "#'()/;[\\\]{}]/g, sr = /[,\t\n\f\r !"#'():;@[\\\]{}]|\/(?=\*)/g, Gf = /.[\r\n"'(/\\]/, jo = /[\da-f]/i, nr = /[\n\f\r]/g;
  Jo.exports = function(e, s = {}) {
    let r = e.css.valueOf(), n = s.ignoreErrors, i, o, a, u, c, f, p, l, g, x = r.length, h = 0, d = [], m = [], _;
    function w() {
      return h;
    }
    function v(T) {
    ...
    function F() {
      let T = 1, C = !1, A = !1;
      for (; T > 0; )
        o += 1, r.length <= o && v("interpolation"), i = r.charCodeAt(o), l = r.charCodeAt(o + 1), C ? !A && i === C ? (C = !1, A = !1) : i === 92 ? A = !A : A && (A = !1) : i === 39 || i === 34 ? C = i : i === 125 ? T -= 1 : i === 35 && l === 123 && (T += 1);
    }
    function K(T) {
      if (m.length)
        return m.pop();
        ...
        case 40: {
          if (p = d.length ? d.pop()[1] : "", l = r.charCodeAt(h + 1), p === "url" && l !== 39 && l !== 34) {
            for (_ = 1, f = !1, o = h + 1; o <= r.length - 1; ) {
              if (l = r.charCodeAt(o), l === 92)
                f = !f;
              else if (l === 40)
                _ += 1;
              else if (l === 41 && (_ -= 1, _ === 0))
                break;
              o += 1;
            }
            u = r.slice(h, o + 1), g = ["brackets", u, h, o], h = o;
          } else
            o = r.indexOf(")", h + 1), u = r.slice(h, o + 1), o === -1 || Gf.test(u) ? g = ["(", "(", h] : (g = ["brackets", u, h, o], h = o);
          break;
        }
        case 39:
        case 34: {
          for (a = i, o = h, f = !1; o < x && (o++, o === x && v("string"), i = r.charCodeAt(o), l = r.charCodeAt(o + 1), !(!f && i === a)); )
    ...
    return { back: $, endOfFile: R, nextToken: K, position: w };
  };
}), ea = y((ex, Zo) => {
  var { Comment: Hf } = tr(), Kf = jt(), Qf = Qo(), jf = Xo(), Cs = class extends Kf {
    atrule(e) {
      let s = e[1], r = e;
      for (; !this.tokenizer.endOfFile(); ) {
        let n = this.tokenizer.nextToken();
        if (n[0] === "word" && n[2] === r[3] + 1)
          s += n[1], r = n;
        else {
...
`))
  ...
  var { Input: Jf } = tr(), Xf = ea();
  ta.exports = function(e, s) {
    let r = new Jf(e, s), n = new Xf(r);
  ...
  vt.prototype = Object.create(na.default.prototype), vt.constructor = na.default, vt.prototype.walk = function(e, s) {
    for (var r = typeof e == "string" || e instanceof RegExp, n = r ? s : e, i = typeof e == "string" ? new RegExp(e) : e, o = 0; o < this.nodes.length; o++) {
      var a = this.nodes[o], u = r ? i.test(a.type) : !0;
      if (u && n && n(a, o, this.nodes) === !1 || a.nodes && a.walk(e, s) === !1)
        return !1;
    }
    return !0;
    ...
    for (var e = arguments.length <= 0 || arguments[0] === void 0 ? function() {
      ...
      var r = this.nodes[s];
      if (e(r, s, this.nodes) === !1)
        return !1;
    }
    return !0;
  }, Ns.default = vt;
}), ua = y((xt) => {
  Object.defineProperty(xt, "__esModule", { value: !0 }), xt.parseMediaFeature = aa, xt.parseMediaQuery = Is, xt.parseMediaList = ip;
  var sp = Os(), ia = oa(sp), np = Ps(), Rs = oa(np);
  function oa(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function aa(t) {
    ...
    for (var f = 0; f < c.length; f++) {
      var p = c[f];
      if ((p === "'" || p === '"') && (s[n].isCalculationEnabled === !0 ? (s.push({ mode: "string", isCalculationEnabled: !1, character: p }), n++) : s[n].mode === "string" && s[n].character === p && c[f - 1] !== "\\" && (s.pop(), n--)), p === "{" ? (s.push({ mode: "interpolation", isCalculationEnabled: !0 }), n++) : p === "}" && (s.pop(), n--), s[n].mode === "normal" && p === ":") {
  ...
  function ip(t) {
    ...
    if (n !== null) {
      ...
      e.unshift(new ia.default({ type: "url", value: t.substring(0, i).trim(), sourceIndex: n[1].length, before: n[1], after: /^(\s*)/.exec(t.substring(i))[1] })), s = i;
    }
    for (var u = s; u < t.length; u++) {
      var c = t[u];
      if (c === "(" && r++, c === ")" && r--, r === 0 && c === ",") {
        var f = t.substring(s, u), p = /^(\s*)/.exec(f)[1];
        e.push(new Rs.default({ type: "media-query", value: f.trim(), sourceIndex: s + p.length, nodes: Is(f, s), before: p, after: /(\s*)$/.exec(f)[1] })), s = u + 1;
      }
    }
    var l = t.substring(s), g = /^(\s*)/.exec(l)[1];
    return e.push(new Rs.default({ type: "media-query", value: l.trim(), sourceIndex: s + g.length, nodes: Is(l, s), before: g, after: /(\s*)$/.exec(l)[1] })), e;
  }
}), la = y((qs) => {
  Object.defineProperty(qs, "__esModule", { value: !0 }), qs.default = cp;
  var op = Ps(), ap = lp(op), up = ua();
  function lp(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function cp(t) {
    return new ap.default({ nodes: (0, up.parseMediaList)(t), type: "media-query-list", value: t.trim() });
  }
}), Ds = y((cx, pa) => {
  ...
  ha.exports = function(t, e) {
    for (var s = -1, r = []; (s = t.indexOf(e, s + 1)) !== -1; )
      r.push(s);
    return r;
  };
}), Bs = y((px, da) => {
  ...
  var gp = function t(e, s) {
    if ((typeof e > "u" ? "undefined" : ma(e)) !== "object")
      return e;
    var r = new e.constructor();
    for (var n in e)
      if (e.hasOwnProperty(n)) {
        var i = e[n], o = typeof i > "u" ? "undefined" : ma(i);
    ...
    return t.prototype.remove = function() {
      ...
      var s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, r = gp(this);
      for (var n in s)
        r[n] = s[n];
      return r;
  ...
  ir.default = wp, ya.exports = ir.default;
}), D = y((B) => {
  B.__esModule = !0, B.TAG = "tag", B.STRING = "string", B.SELECTOR = "selector", B.ROOT = "root", B.PSEUDO = "pseudo", B.NESTING = "nesting", B.ID = "id", B.COMMENT = "comment", B.COMBINATOR = "combinator", B.CLASS = "class", B.ATTRIBUTE = "attribute", B.UNIVERSAL = "universal";
}), ar = y((or, ga) => {
  or.__esModule = !0;
  ...
  var Ap = function(t) {
    ...
    return e.prototype.append = function(r) {
      ...
      if (this.indexes[n] = 0, !!this.length) {
        for (var i = void 0, o = void 0; this.indexes[n] < this.length && (i = this.indexes[n], o = r(this.at(i), i), o !== !1); )
          this.indexes[n] += 1;
        if (delete this.indexes[n], o === !1)
          return !1;
      }
    }, e.prototype.walk = function(r) {
      return this.each(function(n, i) {
        var o = r(n, i);
        if (o !== !1 && n.length && (o = n.walk(r)), o === !1)
          return !1;
      });
    }, e.prototype.walkAttributes = function(r) {
      var n = this;
      return this.walk(function(i) {
        if (i.type === X.ATTRIBUTE)
          return r.call(n, i);
      });
  ...
  or.default = Ap, ga.exports = or.default;
}), va = y((ur, wa) => {
  ur.__esModule = !0;
  var Op = ar(), Np = Rp(Op), Pp = D();
  function Rp(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function Ip(t, e) {
  ...
  ur.default = Dp, wa.exports = ur.default;
}), _a = y((lr, xa) => {
  lr.__esModule = !0;
  var Mp = ar(), Bp = Fp(Mp), Up = D();
  function Fp(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function $p(t, e) {
  ...
  lr.default = Yp, xa.exports = lr.default;
}), De = y((cr, ba) => {
  cr.__esModule = !0;
  var Vp = /* @__PURE__ */ function() {
    function t(e, s) {
  ...
  var Xp = function(t) {
    ...
    }, Vp(e, [{ key: "ns", get: function() {
      var r = this.namespace;
      return r ? (typeof r == "string" ? r : "") + "|" : "";
    } }]), e;
  }(Hp.default);
  cr.default = Xp, ba.exports = cr.default;
}), Ea = y((fr, ka) => {
  fr.__esModule = !0;
  var Zp = De(), eh = rh(Zp), th = D();
  function rh(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function sh(t, e) {
  ...
  fr.default = oh, ka.exports = fr.default;
}), Ta = y((pr, Sa) => {
  pr.__esModule = !0;
  var ah = we(), uh = ch(ah), lh = D();
  function ch(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function fh(t, e) {
  ...
  pr.default = dh, Sa.exports = pr.default;
}), Aa = y((hr, Ca) => {
  hr.__esModule = !0;
  var mh = De(), yh = wh(mh), gh = D();
  function wh(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function vh(t, e) {
  ...
  hr.default = bh, Ca.exports = hr.default;
}), Na = y((dr, Oa) => {
  dr.__esModule = !0;
  var kh = De(), Eh = Th(kh), Sh = D();
  function Th(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function Ch(t, e) {
  ...
  dr.default = Nh, Oa.exports = dr.default;
}), Ra = y((mr, Pa) => {
  mr.__esModule = !0;
  var Ph = we(), Rh = qh(Ph), Ih = D();
  function qh(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function Lh(t, e) {
  ...
  mr.default = Bh, Pa.exports = mr.default;
}), qa = y((yr, Ia) => {
  yr.__esModule = !0;
  var Uh = ar(), Fh = Wh(Uh), $h = D();
  function Wh(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function zh(t, e) {
  ...
  yr.default = Gh, Ia.exports = yr.default;
}), Da = y((gr, La) => {
  gr.__esModule = !0;
  var Hh = De(), Kh = jh(Hh), Qh = D();
  function jh(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function Jh(t, e) {
  ...
  gr.default = ed, La.exports = gr.default;
}), Ba = y((wr, Ma) => {
  wr.__esModule = !0;
  var td = De(), rd = nd(td), sd = D();
  function nd(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function id(t, e) {
  ...
  wr.default = ud, Ma.exports = wr.default;
}), Fa = y((vr, Ua) => {
  vr.__esModule = !0;
  var ld = we(), cd = pd(ld), fd = D();
  function pd(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function hd(t, e) {
  ...
  vr.default = yd, Ua.exports = vr.default;
}), Wa = y((xr, $a) => {
  xr.__esModule = !0;
  var gd = we(), wd = xd(gd), vd = D();
  function xd(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function _d(t, e) {
  ...
  xr.default = Ed, $a.exports = xr.default;
}), Ya = y((_r, za) => {
  _r.__esModule = !0, _r.default = Sd;
  function Sd(t) {
  ...
  Er.__esModule = !0, Er.default = Dd;
  var Va = 39, Td = 34, Us = 92, Ga = 47, _t = 10, Fs = 32, $s = 12, Ws = 9, zs = 13, Ha = 43, Ka = 62, Qa = 126, ja = 124, Cd = 44, Ad = 40, Od = 41, Nd = 91, Pd = 93, Rd = 59, Ja = 42, Id = 58, qd = 38, Ld = 64, br = /[ \n\t\r\{\(\)'"\\;/]/g, kr = /[ \n\t\r\(\)\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g;
  function Dd(t) {
    for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, a = void 0, u = void 0, c = void 0, f = void 0, p = void 0, l = void 0, g = void 0, x = s.length, h = -1, d = 1, m = 0, _ = function(v, R) {
      if (t.safe)
        ...
        throw t.error("Unclosed " + v, d, m - h, m);
    }; m < x; ) {
      switch (r = s.charCodeAt(m), r === _t && (h = m, d += 1), r) {
        ...
        case $s:
          n = m;
          do
            n += 1, r = s.charCodeAt(n), r === _t && (h = n, d += 1);
          while (r === Fs || r === _t || r === Ws || r === zs || r === $s);
        ...
        case Td:
          i = r === Va ? "'" : '"', n = m;
          do
            for (l = !1, n = s.indexOf(i, n + 1), n === -1 && _("quote", i), g = n; s.charCodeAt(g - 1) === Us; )
              g -= 1, l = !l;
          while (l);
        ...
        case Ld:
          ...
          break;
        case Us:
          for (n = m, c = !0; s.charCodeAt(n + 1) === Us; )
            n += 1, c = !c;
...
`), a = o.length - 1, a > 0 ? (f = d + a, p = n - o[a].length) : (f = d, p = h), e.push(["comment", u, d, m - h, f, n - p, m]), h = p, d = f, m = n) : (kr.lastIndex = m + 1, kr.test(s), kr.lastIndex === 0 ? n = s.length - 1 : n = kr.lastIndex - 2, e.push(["word", s.slice(m, n + 1), d, m - h, d, n - h, m]), m = n);
  ...
  }(), Bd = Ds(), Ud = I(Bd), Fd = Ms(), Ys = I(Fd), $d = Bs(), Wd = I($d), zd = va(), Yd = I(zd), Vd = _a(), Vs = I(Vd), Gd = Ea(), Hd = I(Gd), Kd = Ta(), Qd = I(Kd), jd = Aa(), Jd = I(jd), Xd = Na(), Zd = I(Xd), em = Ra(), tm = I(em), rm = qa(), sm = I(rm), nm = Da(), im = I(nm), om = Ba(), am = I(om), um = Fa(), lm = I(um), cm = Wa(), fm = I(cm), pm = Ya(), hm = I(pm), dm = Za(), eu = I(dm), mm = D(), ym = gm(mm);
  function gm(t) {
    if (t && t.__esModule)
      return t;
    var e = {};
  ...
  var vm = function() {
    function t(e) {
      ...
      return this.root.append(s), this.current = s, this.lossy ? this.tokens = (0, eu.default)({ safe: e.safe, css: e.css.trim() }) : this.tokens = (0, eu.default)(e), this.loop();
    }
    return t.prototype.attribute = function() {
      ...
      for (var s = new lm.default({ value: "", source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] }); this.position < this.tokens.length && this.currToken && (this.currToken[0] === "space" || this.currToken[0] === "combinator"); )
      ...
      this.newNode(new fm.default({ value: this.currToken[1], source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] })), this.position++;
    }, t.prototype.parentheses = function() {
      var s = this.current.last;
      if (s && s.type === ym.PSEUDO) {
        var r = new Vs.default(), n = this.current;
        s.append(r), this.current = r;
        var i = 1;
        for (this.position++; this.position < this.tokens.length && i; )
          this.currToken[0] === "(" && i++, this.currToken[0] === ")" && i--, i ? this.parse() : (r.parent.source.end.line = this.currToken[2], r.parent.source.end.column = this.currToken[3], this.position++);
        i && this.error("Expected closing parenthesis."), this.current = n;
      } else {
        var o = 1;
        for (this.position++, s.value += "("; this.position < this.tokens.length && o; )
          this.currToken[0] === "(" && o++, this.currToken[0] === ")" && o--, s.value += this.parseParenthesisToken(this.currToken), this.position++;
      ...
      if (this.currToken[0] === "word") {
        ...
        this.splitWord(!1, function(o, a) {
          r += o, i = new sm.default({ value: r, source: { start: { line: n[2], column: n[3] }, end: { line: s.currToken[4], column: s.currToken[5] } }, sourceIndex: n[4] }), s.newNode(i), a > 1 && s.nextToken && s.nextToken[0] === "(" && s.error("Misplaced parenthesis.");
        });
      } else
      ...
      var s = this.currToken;
      this.newNode(new tm.default({ value: this.currToken[1], source: { start: { line: s[2], column: s[3] }, end: { line: s[4], column: s[5] } }, sourceIndex: s[6] })), this.position++;
    }, t.prototype.universal = function(s) {
      var r = this.nextToken;
      if (r && r[1] === "|")
        return this.position++, this.namespace();
      this.newNode(new am.default({ value: this.currToken[1], source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] }), s), this.position++;
      ...
      l.forEach(function(g, x) {
        var h = l[x + 1] || o.length, d = o.slice(g, h);
        if (x === 0 && r)
          return r.call(n, d, l.length);
        var m = void 0;
        ~c.indexOf(g) ? m = new Hd.default({ value: d.slice(1), source: { start: { line: n.currToken[2], column: n.currToken[3] + g }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }) : ~f.indexOf(g) ? m = new Jd.default({ value: d.slice(1), source: { start: { line: n.currToken[2], column: n.currToken[3] + g }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }) : m = new Zd.default({ value: d, source: { start: { line: n.currToken[2], column: n.currToken[3] + g }, end: { line: n.currToken[4], column: n.currToken[3] + (h - 1) } }, sourceIndex: n.currToken[6] + l[x] }), n.newNode(m, s);
      }), this.position++;
  ...
  Sr.default = vm, tu.exports = Sr.default;
}), nu = y((Tr, su) => {
  Tr.__esModule = !0;
  ...
  var Sm = function() {
    function t(e) {
      return Em(this, t), this.func = e || function() {
      }, this;
    }
    return t.prototype.process = function(s) {
      var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = new bm.default({ css: s, error: function(o) {
        throw new Error(o);
      }, options: r });
      return this.res = n, this.func(n), this;
    }, xm(t, [{ key: "result", get: function() {
      return String(this.res);
    } }]), t;
  }();
  Tr.default = Sm, su.exports = Tr.default;
}), Y = y((Ox, ou) => {
  var Gs = function(t, e) {
    let s = new t.constructor();
    for (let r in t) {
...
` ? (r = 1, n += 1) : r += 1;
  ...
  pu.registerWalker(Cr), hu.exports = Cr;
}), yu = y((Dx, mu) => {
  var Nm = U(), Pm = Y(), Ar = class extends Pm {
    constructor(e) {
      super(e), this.type = "colon";
    }
  };
  Nm.registerWalker(Ar), mu.exports = Ar;
}), wu = y((Mx, gu) => {
  var Rm = U(), Im = Y(), Or = class extends Im {
    constructor(e) {
      super(e), this.type = "comma";
    }
  };
  Rm.registerWalker(Or), gu.exports = Or;
}), xu = y((Bx, vu) => {
  var qm = U(), Lm = Y(), Nr = class extends Lm {
    constructor(e) {
  ...
  qm.registerWalker(Nr), vu.exports = Nr;
}), ku = y((Ux, bu) => {
  var _u = U(), Pr = class extends _u {
    constructor(e) {
      super(e), this.type = "func", this.unbalanced = -1;
    }
  };
  _u.registerWalker(Pr), bu.exports = Pr;
}), Su = y((Fx, Eu) => {
  var Dm = U(), Mm = Y(), Rr = class extends Mm {
    constructor(e) {
  ...
  Dm.registerWalker(Rr), Eu.exports = Rr;
}), Cu = y(($x, Tu) => {
  var Bm = U(), Um = Y(), Ir = class extends Um {
    constructor(e) {
      super(e), this.type = "operator";
    }
  };
  Bm.registerWalker(Ir), Tu.exports = Ir;
}), Ou = y((Wx, Au) => {
  var Fm = U(), $m = Y(), qr = class extends $m {
    constructor(e) {
      super(e), this.type = "paren", this.parenType = "";
    }
  };
  Fm.registerWalker(qr), Au.exports = qr;
}), Pu = y((zx, Nu) => {
  var Wm = U(), zm = Y(), Lr = class extends zm {
    constructor(e) {
  ...
  Wm.registerWalker(Lr), Nu.exports = Lr;
}), Iu = y((Yx, Ru) => {
  var Ym = U(), Vm = Y(), Dr = class extends Vm {
    constructor(e) {
      super(e), this.type = "word";
    }
  };
  Ym.registerWalker(Dr), Ru.exports = Dr;
}), Lu = y((Vx, qu) => {
  var Gm = U(), Hm = Y(), Mr = class extends Hm {
    constructor(e) {
      super(e), this.type = "unicode-range";
    }
  };
  Gm.registerWalker(Mr), qu.exports = Mr;
}), Mu = y((Gx, Du) => {
  ...
  var Br = /[ \n\t\r\{\(\)'"\\;,/]/g, Km = /[ \n\t\r\(\)\{\}\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g, Be = /[ \n\t\r\(\)\{\}\*:;@!&'"\-\+\|~>,\[\]\\]|\//g, Qm = /^[a-z0-9]/i, jm = /^[a-f0-9?\-]/i, Bu = Mu();
  Uu.exports = function(e, s) {
    s = s || {};
    let r = [], n = e.valueOf(), i = n.length, o = -1, a = 1, u = 0, c = 0, f = null, p, l, g, x, h, d, _, w, v, R, F;
    function K(T) {
      let C = `Unclosed ${T} at line: ${a}, column: ${u - o}, token: ${u}`;
      throw new Bu(C);
    }
    for (; u < i; ) {
      switch (p = n.charCodeAt(u), p === 10 && (o = u, a += 1), p) {
        ...
        case 34:
          g = p === 39 ? "'" : '"', l = u;
          do
            for (v = !1, l = n.indexOf(g, l + 1), l === -1 && K("quote"), R = l; n.charCodeAt(R - 1) === 92; )
              R -= 1, v = !v;
          while (v);
        ...
        case 45:
        case 42:
          if (l = u + 1, F = n.slice(u + 1, l + 1), n.slice(u - 1, u), p === 45 && F.charCodeAt(0) === 45) {
        ...
        default:
          if (p === 47 && (n.charCodeAt(u + 1) === 42 || s.loose && !f && n.charCodeAt(u + 1) === 47)) {
            if (n.charCodeAt(u + 1) === 42)
              l = n.indexOf("*/", u + 2) + 1, l === 0 && K("comment");
            else {
              let A = n.indexOf(`
`, u + 2);
              l = A !== -1 ? A - 1 : i;
...
`), h = x.length - 1, h > 0 ? (_ = a + h, w = l - x[h].length) : (_ = a, w = o), r.push(["comment", d, a, u - o, _, l - w, u]), o = w, a = _, u = l;
          } else if (p === 35 && !Qm.test(n.slice(u + 1, u + 2)))
            ...
            l = u + 1, r.push(["operator", n.slice(u, l), a, u - o, a, l - o, u]), u = l - 1;
          else {
            let C = Km;
            if (p >= 48 && p <= 57 && (C = Be), C.lastIndex = u + 1, C.test(n), C.lastIndex === 0 ? l = n.length - 1 : l = C.lastIndex - 2, C === Be || p === 46) {
              let A = n.charCodeAt(l), ve = n.charCodeAt(l + 1), Zs = n.charCodeAt(l + 2);
  ...
  var Jm = lu(), Xm = fu(), Zm = du(), ey = yu(), ty = wu(), ry = xu(), sy = ku(), ny = Su(), iy = Cu(), zu = Ou(), oy = Pu(), Yu = Iu(), ay = Lu(), uy = Fu(), ly = Ds(), cy = Ms(), fy = Bs(), py = Wu();
  function hy(t) {
  ...
  Vu.exports = class {
    ...
    colon() {
      ...
      this.newNode(new ey({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++;
    }
    comma() {
      let e = this.currToken;
    ...
    comment() {
      ...
      this.options.loose && s.startsWith("//") && (s = s.substring(2), e = !0), r = new ry({ value: s, inline: e, source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[4], column: this.currToken[5] } }, sourceIndex: this.currToken[6] }), this.newNode(r), this.position++;
    }
    error(e, s) {
    ...
    operator() {
      ...
      return s = new iy({ value: this.currToken[1], source: { start: { line: this.currToken[2], column: this.currToken[3] }, end: { line: this.currToken[2], column: this.currToken[3] } }, sourceIndex: this.currToken[4] }), this.position++, this.newNode(s);
    }
    parseTokens() {
      switch (this.currToken[0]) {
        case "space":
    ...
    parenClose() {
      let e = this.currToken;
      this.newNode(new zu({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++, !(this.position >= this.tokens.length - 1 && !this.current.unbalanced) && (this.current.unbalanced--, this.current.unbalanced < 0 && this.error("Expected opening parenthesis", e), !this.current.unbalanced && this.cache.length && (this.current = this.cache.pop()));
    }
    space() {
      let e = this.currToken;
    ...
    unicodeRange() {
      let e = this.currToken;
      this.newNode(new ay({ value: e[1], source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6] })), this.position++;
    }
    splitWord() {
      ...
      i = cy(s, "@"), o = hy(fy(ly([[0], i]))), o.forEach((a, u) => {
        ...
        if (~i.indexOf(a))
          p = new Zm({ value: f.slice(1), source: { start: { line: this.currToken[2], column: this.currToken[3] + a }, end: { line: this.currToken[4], column: this.currToken[3] + (c - 1) } }, sourceIndex: this.currToken[6] + o[u] });
        else if (r.test(this.currToken[1])) {
          let l = f.replace(r, "");
          p = new ny({ value: f.replace(l, ""), source: { start: { line: this.currToken[2], column: this.currToken[3] + a }, end: { line: this.currToken[4], column: this.currToken[3] + (c - 1) } }, sourceIndex: this.currToken[6] + o[u], unit: l });
        } else
          p = new (e && e[0] === "(" ? sy : Yu)({ value: f, source: { start: { line: this.currToken[2], column: this.currToken[3] + a }, end: { line: this.currToken[4], column: this.currToken[3] + (c - 1) } }, sourceIndex: this.currToken[6] + o[u] }), p.type === "word" ? (p.isHex = /^#(.+)/.test(f), p.isColor = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(f)) : this.cache.push(this.current);
        this.newNode(p);
      }), this.position++;
    }
    string() {
      let e = this.currToken, s = this.currToken[1], r = /^(\"|\')/, n = r.test(s), i = "", o;
      n && (i = s.match(r)[0], s = s.slice(1, s.length - 1)), o = new oy({ value: s, source: { start: { line: e[2], column: e[3] }, end: { line: e[4], column: e[5] } }, sourceIndex: e[6], quoted: n }), o.raws.quote = i, this.newNode(o), this.position++;
    }
    word() {
...
en(Xs, { languages: () => hi, options: () => mi, parsers: () => Js, printers: () => Oy });
var dl = (t, e, s, r) => {
  if (!(t && e == null))
    return e.replaceAll ? e.replaceAll(s, r) : s.global ? e.replace(s, r) : e.split(s).join(r);
}, E = dl, Ue = "string", Fe = "array", $e = "cursor", xe = "indent", _e = "align", We = "trim", be = "group", ee = "fill", le = "if-break", ze = "indent-if-break", Ye = "line-suffix", Ve = "line-suffix-boundary", Q = "line", Ge = "label", ke = "break-parent", bt = /* @__PURE__ */ new Set([$e, xe, _e, We, be, ee, le, ze, Ye, Ve, Q, Ge, ke]);
function ml(t) {
  if (typeof t == "string")
    return Ue;
  if (Array.isArray(t))
...
var He = ml, yl = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function gl(t) {
...
var Wr = class extends Error {
  ...
  constructor(e) {
    super(gl(e)), this.doc = e;
  }
}, zr = Wr;
function q(t) {
  return { type: xe, contents: t };
}
function rn(t, e) {
  return { type: _e, contents: e, n: t };
}
function L(t, e = {}) {
  return { type: be, id: e.id, contents: t, break: !!e.shouldBreak, expandedStates: e.expandedStates };
}
function sn(t) {
  return rn({ type: "root" }, t);
}
function fe(t) {
  return rn(-1, t);
}
function Ke(t) {
  return { type: ee, parts: t };
}
function Et(t, e = "", s = {}) {
  return { type: le, breakContents: t, flatContents: e, groupId: s.groupId };
}
var Qe = { type: ke }, wl = { type: Q, hard: !0 }, O = { type: Q }, M = { type: Q, soft: !0 }, k = [wl, Qe];
function V(t, e) {
  let s = [];
  for (let r = 0; r < e.length; r++)
    r !== 0 && s.push(t), s.push(e[r]);
  return s;
}
var vl = (t, e, s) => {
  if (!(t && e == null))
  ...
  if (Array.isArray(t))
    return t;
  if (t.type !== ee)
    throw new Error(`Expect doc to be 'array' or '${ee}'.`);
  return t.parts;
};
function xl(t, e) {
  if (typeof t == "string")
...
var te = bl, St = "'", an = '"';
function kl(t, e) {
  let s = e === !0 || e === St ? St : an, r = s === St ? an : St, n = 0, i = 0;
  for (let o of t)
    o === s ? n++ : o === r && i++;
  return n > i ? r : s;
}
var un = kl;
function El(t, e, s) {
  let r = e === '"' ? "'" : '"', i = E(!1, t, /\\(.)|(["'])/gs, (o, a, u) => a === r ? a : u === e ? "\\" + u : u || (s && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(a) ? a : "\\" + a));
  return e + i + e;
}
var ln = El;
function Sl(t, e) {
  let s = t.slice(1, -1), r = e.parser === "json" || e.parser === "jsonc" || e.parser === "json5" && e.quoteProps === "preserve" && !e.singleQuote ? '"' : e.__isInHtmlAttribute ? "'" : un(s, e.singleQuote);
  return ln(s, r, !(e.parser === "css" || e.parser === "less" || e.parser === "scss" || e.__embeddedInHtml));
}
var Tt = Sl, Yr = class extends Error {
...
function Tl(t) {
  return t?.type === "front-matter";
}
var Ee = Tl, Cl = /* @__PURE__ */ new Set(["raw", "raws", "sourceIndex", "source", "before", "after", "trailingComma", "spaces"]);
function fn(t, e, s) {
  if (Ee(t) && t.lang === "yaml" && delete e.value, t.type === "css-comment" && s.type === "css-root" && s.nodes.length > 0 && ((s.nodes[0] === t || Ee(s.nodes[0]) && s.nodes[1] === t) && (delete e.text, /^\*\s*@(?:format|prettier)\s*$/.test(t.text)) || s.type === "css-root" && G(!1, s.nodes, -1) === t))
    return null;
  ...
  if (t.type === "value-comma_group" && t.groups.some((r) => r.type === "value-atword" && r.value.endsWith("[") || r.type === "value-word" && r.value.startsWith("]")))
    return { type: "value-atword", value: t.groups.map((r) => r.value).join(""), group: { open: null, close: null, groups: [], type: "value-paren_group" } };
}
...
` || a === "\r") && (n && i.push([r, o]), e = "initial", n = !1);
  ...
  for (let [o, a] of i)
    t = t.slice(0, o) + E(!1, t.slice(o, a), /["'*]/g, " ") + t.slice(a);
  return t;
}
function N(t) {
  var e;
...
function Pn(t) {
  ...
  let s = (0, re.extract)(t), { pragmas: r, comments: n } = (0, re.parseWithComments)(s);
...
function In(t) {
  let { shebang: e, text: s, pragmas: r, comments: n } = Pn(t), i = (0, re.strip)(s), o = (0, re.print)({ pragmas: { format: "", ...r }, comments: n.trimStart() });
  return (e ? `${e}
` : "") + o + (i.startsWith(`
`) ? `
` : `
...
function Hl(t) {
  ...
  if (!e)
    return { content: t };
  let { startDelimiter: s, language: r, value: n = "", endDelimiter: i } = e.groups, o = r.trim() || "yaml";
  if (s === "+++" && (o = "toml"), o !== "yaml" && s !== i)
    return { content: t };
  let [a] = e;
  return { frontMatter: { type: "front-matter", lang: o, value: n, startDelimiter: s, endDelimiter: i, raw: a.replace(/\n$/, "") }, content: E(!1, a, /[^\n]/g, " ") + t.slice(a.length) };
}
var Xe = Hl;
function qn(t) {
...
var Kl = /* @__PURE__ */ new Set(["red", "green", "blue", "alpha", "a", "rgb", "hue", "h", "saturation", "s", "lightness", "l", "whiteness", "w", "blackness", "b", "tint", "shade", "blend", "blenda", "contrast", "hsl", "hsla", "hwb", "hwba"]);
function Dn(t) {
  var e, s;
  return (s = (e = t.findAncestor((r) => r.type === "css-decl")) == null ? void 0 : e.prop) == null ? void 0 : s.toLowerCase();
}
var Ql = /* @__PURE__ */ new Set(["initial", "inherit", "unset", "revert"]);
function Mn(t) {
...
function Bn(t, e) {
  ...
  return ((r = s?.name) == null ? void 0 : r.toLowerCase().endsWith("keyframes")) && ["from", "to"].includes(e.toLowerCase());
}
function se(t) {
...
function Se(t, e) {
  ...
  return ((r = s?.value) == null ? void 0 : r.toLowerCase()) === e;
}
function Un(t) {
  var r;
  let e = t.findAncestor((n) => n.type === "css-rule"), s = (r = e?.raws) == null ? void 0 : r.selector;
...
function Jr(t, e) {
  ...
  return !!((i = n?.prop) != null && i.startsWith("$") || Qr(r) || r.type === "value-func");
}
function Xr(t) {
...
function ri(t, e) {
  var s, r;
  if (((s = t.open) == null ? void 0 : s.value) !== "(" || ((r = t.close) == null ? void 0 : r.value) !== ")" || t.groups.some((n) => n.type !== "value-comma_group"))
    return !1;
...
function Jl(t, e, s) {
  var d;
  let { node: r } = t, n = t.parent, i = t.grandparent, o = Dn(t), a = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), u = t.findAncestor((m) => m.type === "css-atrule"), c = u && et(u, e), f = r.groups.some((m) => Xr(m)), p = t.map(s, "groups"), l = [], g = Se(t, "url"), x = !1, h = !1;
  for (let m = 0; m < r.groups.length; ++m) {
    l.push(p[m]);
    let _ = r.groups[m - 1], w = r.groups[m], v = r.groups[m + 1], R = r.groups[m + 2];
    if (g) {
      (v && j(v) || j(w)) && l.push(" ");
      continue;
    }
    if (Te(t, "forward") && w.type === "value-word" && w.value && _ !== void 0 && _.type === "value-word" && _.value === "as" && v.type === "value-operator" && v.value === "*" || !v || w.type === "value-word" && w.value.endsWith("-") && rt(v))
      continue;
    if (w.type === "value-string" && w.quoted) {
      let A = w.value.lastIndexOf("#{"), ve = w.value.lastIndexOf("}");
      A !== -1 && ve !== -1 ? x = A > ve : A !== -1 ? x = !0 : ve !== -1 && (x = !1);
    }
    if (x || Mt(w) || Mt(v) || w.type === "value-atword" && (w.value === "" || w.value.endsWith("[")) || v.type === "value-word" && v.value.startsWith("]") || w.value === "~" || w.type !== "value-string" && w.value && w.value.includes("\\") && v && v.type !== "value-comment" || _ != null && _.value && _.value.indexOf("\\") === _.value.length - 1 && w.type === "value-operator" && w.value === "/" || w.value === "\\" || jn(w, v) || Lt(w) || Zr(w) || Dt(v) || Zr(v) && de(v) || Dt(w) && de(v) || w.value === "--" && Lt(v))
      continue;
    let F = Rt(w), K = Rt(v);
    if ((F && Lt(v) || K && Dt(w)) && de(v) || !_ && Ze(w) || Se(t, "calc") && (j(w) || j(v) || he(w) || he(v)) && de(v))
      continue;
    let $ = (j(w) || he(w)) && m === 0 && (v.type === "value-number" || v.isHex) && i && ti(i) && !de(v), T = R?.type === "value-func" || R && tt(R) || w.type === "value-func" || tt(w), C = v.type === "value-func" || tt(v) || _?.type === "value-func" || _ && tt(_);
...
var Bt = sc;
function nc(t, e, s = {}) {
  let r = At(t, s.backwards ? e - 1 : e, s), n = Bt(t, r, s);
  return r !== n;
}
var Ut = nc;
function ic(t, e) {
...
function ac(t, e) {
  let s = null, r = e;
  for (; r !== s; )
    s = r, r = vn(t, r), r = li(t, r), r = At(t, r);
...
function fi(t, e, s) {
  ...
  if (n && $n(n) && (r.groups.length === 1 || r.groups.length > 0 && r.groups[0].type === "value-comma_group" && r.groups[0].groups.length > 0 && r.groups[0].groups[0].type === "value-word" && r.groups[0].groups[0].value.startsWith("data:")))
    return [r.open ? s("open") : "", V(",", i), r.close ? s("close") : ""];
  if (!r.open) {
    let g = rs(t), x = V([",", g ? k : O], i);
  ...
  let o = t.map(({ node: g, isLast: x, index: h }) => {
    ...
    return m;
  }, "groups"), a = Zn(r, n), u = ri(r, n), c = Jr(t, e), f = u || c && !a, p = u || a, l = L([r.open ? s("open") : "", q([M, V(O, o)]), M, r.close ? s("close") : ""], { shouldBreak: f });
  return p ? fe(l) : l;
}
function rs(t) {
...
function cc(t, e, s) {
  ...
  return t.each(() => {
    ...
    if (i?.type === "css-comment" && i.text.trim() === "prettier-ignore" ? r.push(e.originalText.slice(N(n), P(n))) : r.push(s()), t.isLast)
      return;
    let { next: o } = t;
    o.type === "css-comment" && !Ut(e.originalText, N(o), { backwards: !0 }) && !Ee(n) || o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment" ? r.push(" ") : (r.push(e.__isHTMLStyleAttribute ? O : k), Ft(e.originalText, P(n)) && !Ee(n) && r.push(k));
  }, "nodes"), r;
}
var Ae = cc;
function fc(t, e, s) {
  ...
  switch (r.type) {
    case "front-matter":
      return [r.raw, k];
    case "css-root": {
      let f = Ae(t, e, s), p = r.raws.after.trim();
      return p.startsWith(";") && (p = p.slice(1).trim()), [r.frontMatter ? [s("frontMatter"), k] : "", f, p ? ` ${p}` : "", r.nodes.length > 0 ? k : ""];
    }
    case "css-comment": {
    ...
    case "css-decl": {
      let f = t.parent, { between: p } = r.raws, l = p.trim(), g = l === ":", x = typeof r.value == "string" && /^ *$/.test(r.value), h = typeof r.value == "string" ? r.value : s("value");
    ...
    case "css-atrule": {
      let f = t.parent, p = It(r) && !f.raws.semicolon && e.originalText[P(r) - 1] !== ";";
      if (e.parser === "less") {
        if (r.mixin)
        ...
        if (r.variable)
          return ["@", r.name, ": ", r.value ? s("value") : "", r.raws.between.trim() ? r.raws.between.trim() + " " : "", r.nodes ? ["{", q([r.nodes.length > 0 ? M : "", Ae(t, e, s)]), M, "}"] : "", p ? "" : ";"];
      }
    ...
    case "selector-attribute":
      return ["[", r.namespace ? [r.namespace === !0 ? "" : r.namespace.trim(), "|"] : "", r.attribute.trim(), r.operator ?? "", r.value ? ai(W(r.value.trim(), e), e) : "", r.insensitive ? " i" : "", "]"];
    case "selector-combinator": {
      if (r.value === "+" || r.value === ">" || r.value === "~" || r.value === ">>>") {
        let l = t.parent;
        return [l.type === "selector-selector" && l.nodes[0] === r ? "" : O, r.value, Nt(t, r) ? "" : " "];
      }
      let f = r.value.trim().startsWith("(") ? O : "", p = me(W(r.value.trim(), e)) || O;
      return [f, p];
    }
    ...
    case "selector-unknown": {
      ...
      if (f != null && f.isSCSSNesterProperty)
        return me(W(se(r.value), e));
      let p = t.parent;
      if ((c = p.raws) != null && c.selector) {
        let g = N(p), x = g + p.raws.selector.length;
        return e.originalText.slice(g, x).trim();
      }
      let l = t.grandparent;
      if (p.type === "value-paren_group" && l?.type === "value-func" && l.value === "selector") {
        let g = P(p.open) + 1, x = N(p.close), h = e.originalText.slice(g, x).trim();
        return Ce(h) ? [Qe, h] : h;
      }
      return r.value;
    }
    ...
    case "value-colon": {
      let { previous: f } = t;
      return [r.value, typeof f?.value == "string" && f.value.endsWith("\\") || Se(t, "url") ? "" : O];
    }
    case "value-string":
...
function vy(t, e) {
  ...
  for (let c = 0; c < s.length; ++c) {
    ...
    if (f.type === "paren" && f.value === "(")
      r = { open: f, close: null, groups: [], type: "paren_group" }, n.push(r), o = { groups: [], type: "comma_group" }, a.push(o);
    else if (f.type === "paren" && f.value === ")") {
      if (o.groups.length > 0 && r.groups.push(o), r.close = f, a.length === 1)
        throw new Error("Unbalanced parenthesis");
      a.pop(), o = G(!1, a, -1), o.groups.push(r), n.pop(), r = G(!1, n, -1);
    } else
      f.type === "comma" ? (r.groups.push(o), o = { groups: [], type: "comma_group" }, a[a.length - 1] = o) : o.groups.push(f);
  }
...
function Xu(t, e) {
  if (t && typeof t == "object")
    for (let s in t)
      s !== "parent" && (Xu(t[s], e), s === "nodes" && (t.group = Fr(vy(t, e)), delete t[s]));
  return t;
}
function xy(t, e) {
  ...
  let s = null;
  try {
    s = new Ju.default(t, { loose: !0 }).parse();
  } catch {
    return { type: "value-unknown", value: t };
  }
  s.text = t;
...
var ae = xy, _y = /* @__PURE__ */ new Set(["import", "use", "forward"]);
function by(t) {
  return _y.has(t);
}
var Zu = by;
  ...
  if (t && typeof t == "object") {
    ...
    if (t.raws ?? (t.raws = {}), t.type === "css-decl" && typeof t.prop == "string" && t.prop.startsWith("--") && typeof t.value == "string" && t.value.startsWith("{")) {
      ...
      if (t.value.trimEnd().endsWith("}")) {
        let u = e.originalText.slice(0, t.source.start.offset), c = "a".repeat(t.prop.length) + e.originalText.slice(t.source.start.offset + t.prop.length, t.source.end.offset), f = E(!1, u, /[^\n]/g, " ") + c, p;
        ...
        ((s = l?.nodes) == null ? void 0 : s.length) === 1 && l.nodes[0].type === "css-rule" && (a = l.nodes[0].nodes);
      }
    ...
    let o = "";
    if (typeof t.params == "string" && (o = t.raws.params ? t.raws.params.scss ?? t.raws.params.raw : t.params, t.raws.afterName && t.raws.afterName.trim().length > 0 && (o = t.raws.afterName + o), t.raws.between && t.raws.between.trim().length > 0 && (o = o + t.raws.between), o = o.trim(), t.raws.params = o), n.trim().length > 0)
      return n.startsWith("@") && n.endsWith(":") ? t : t.mixin ? (t.selector = ae(n, e), t) : (el(t, e) && (t.isSCSSNesterProperty = !0), t.selector = Z(n), t);
    if (i.length > 0) {
      let a = i.match(Ey);
      a && (i = i.slice(0, a.index), t.scssDefault = !0, a[0].trim() !== "!default" && (t.raws.scssDefault = a[0]));
      let u = i.match(Sy);
      if (u && (i = i.slice(0, u.index), t.scssGlobal = !0, u[0].trim() !== "!global" && (t.raws.scssGlobal = u[0])), i.startsWith("progid:"))
...
function Qs(t, e, s) {
  ...
  try {
    ...
    throw typeof c != "number" ? o : sa(`${a}: ${u}`, { loc: { start: { line: c, column: f } }, cause: o });
  }
  return s.originalText = e, i = nl(J(i, "css-"), s), Kr(i, e), n && (n.source = { startOffset: 0, endOffset: n.raw.length }, i.frontMatter = n), i;
}
function il(t, e = {}) {
...
var js = { astFormat: "postcss", hasPragma: qn, locStart: N, locEnd: P }, Ty = { ...js, parse: il }, Cy = { ...js, parse: ol }, Ay = { ...js, parse: al }, Oy = { postcss: pi }, P_ = Xs;
exports.default = P_;
