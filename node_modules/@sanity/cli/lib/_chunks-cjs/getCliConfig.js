"use strict";
var require$$0 = require("fs"), path = require("path"), worker_threads = require("worker_threads"), cliWorker = require("./cliWorker.js");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var require$$0__default = /* @__PURE__ */ _interopDefaultCompat(require$$0), path__default = /* @__PURE__ */ _interopDefaultCompat(path);
...
function getSanityJsonConfig(cwd) {
  ...
  return require$$0__default.default.existsSync(configPath) ? {
...
function getSanityCliConfig(cwd) {
  const jsConfigPath = path__default.default.join(cwd, "sanity.cli.js"), tsConfigPath = path__default.default.join(cwd, "sanity.cli.ts"), [js, ts] = [require$$0__default.default.existsSync(jsConfigPath), require$$0__default.default.existsSync(tsConfigPath)];
